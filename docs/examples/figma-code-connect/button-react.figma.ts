...
import { DBButton } from './components/button/button';

/**
 * This is an example Code Connect configuration for the DB Button component.
 * It demonstrates how to connect Figma designs with React implementation.
 * 
 * To use this:
...
// Additional variant for icon-only buttons
