...
- And the start slot has been moved out of this element and inserted before it. Consumers targeting the old class in their own CSS or tests need to update the selector (see the v5 to v6 migration guide).
