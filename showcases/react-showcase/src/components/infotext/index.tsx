...
const getInfotext = ({ semantic, size, icon, children, showIcon }: DBInfotextProps) => (
...
const InfotextComponent = (props: BaseComponentProps) => {
	return <DefaultComponent title={'DBInfotext'} variants={getVariants(defaultComponentVariants, getInfotext, props.slotCode)}></DefaultComponent>;
};
