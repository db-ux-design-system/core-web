...
| `scan_v2_migration`            | **Deprecated** alias of `scan_generation_2_migration` — kept so existing configs keep working; will be removed in the next major. Prefer `scan_generation_2_migration`.                                                                                                                                                                                                                                          |
