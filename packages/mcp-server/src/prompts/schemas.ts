...
export const migrateComponentSchema = {
	description:
		'Transforms legacy UI code (e.g., Bootstrap, native HTML, DB UI Generation 1 or 2) into the modern Generation 3 architecture.',
	argsSchema: {
		legacy_code: z
			.string()
			.max(10_000)
			.describe(
				'The source code of the outdated component (e.g., DB UI Generation 1 or 2, Bootstrap, raw HTML/CSS).'
			),
		source_context: z
			.string()
			.max(100)
