...
/** @public Maps a Generation 2 CSS class (cmp-*, elm-*, rea-*) to its Generation 3 CSS class (db-*). */
export type ComponentMigrationEntry = {
	readonly old: string;
	readonly new: string;
};

/** @public Maps a legacy db-color-* token to its Generation 3 background and foreground tokens. */
...
/** @public Maps a legacy icon name to its Generation 3 replacement. */
