...
import type { ExampleCodeFramework } from '../types.js';
...
export type Manifest = {
	...
	components: Record<
		string,
		{
			...
			examples: string[];
			exampleCode: Record<ExampleCodeFramework, Record<string, string>>;
		}
	>;
...
export async function getManifest(): Promise<Manifest> {
	...
	// No cast needed: the generated manifest.json structurally matches Manifest
	// now that exampleCode is keyed by ExampleCodeFramework instead of claiming
	// entries for html and vanilla.
