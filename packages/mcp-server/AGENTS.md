...
- **DB UX Design System – Generation 2 terminology**: In Generation 2, `cmp-*`, `elm-*`, `rea-*` were **CSS classes**, not HTML tags. The actual custom elements were `<db-*>`. Do not confuse these in migration docs or scanner descriptions.
