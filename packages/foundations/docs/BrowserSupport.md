...
| [`:open` CSS pseudo class](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/:open#browser_compatibility)                    | 133 (04.02.2025) | 136 (04.03.2025) | 26.5 (11.05.2026) |
...
| Web Feature                                                                                                                     | Google Chrome    | Mozilla Firefox  | Apple Safari                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ---------------- | -------------------------------------------------------------------------------------------------------- |
| [CSS `field-sizing: content` property](https://caniuse.com/mdn-css_properties_field-sizing_content)                             | 123 (19.03.2024) | 152 (16.06.2026) | [26.2 (12.12.2025)](https://webkit.org/blog/17640/webkit-features-for-safari-26-2/)                      |
...
| Web Feature                                                                                                                                                                    | Google Chrome    | Mozilla Firefox  | Apple Safari                                                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- | ---------------- | ----------------------------------------------------------------------------------- |
| [semantic overflow (`overflow-block` and `overflow-inline`)](https://caniuse.com/mdn-css_properties_overflow-block)                                                            | 135 (01.04.2025) | 69 (03.09.2019)  | 26 (15.09.2025)                                                                     |
...
| [CSS `sibling-count()` and `sibling-index()`](https://caniuse.com/wf-sibling-count) (planned)                                                                                  | 138 (24.06.2025) | 154              | [26.2 (12.12.2025)](https://webkit.org/blog/17640/webkit-features-for-safari-26-2/) |
| [CSS `@scope`](https://caniuse.com/css-cascade-scope) (planned)                                                                                                                | 118 (10.10.2023) | 146 (09.12.2025) | 17.4 (05.03.2024)                                                                   |
| [`focusgroup`](https://chromestatus.com/feature/5637601087193088)                                                                                                              | 150 (17.06.2026) | tbd              | tbd                                                                                 |
| [Relative Alpha Colors (CSS Color 5 `alpha()` function)](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Values/color_value/alpha) (planned)                        | 152 (12.08.2026) | 155              | 27                                                                                  |
