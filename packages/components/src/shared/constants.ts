...
export enum COLOR {
	...
	'BRAND_BG_LEVEL_1' = 'control-panel-brand-bg-basic-level-1',
	'BRAND_BG_LEVEL_2' = 'control-panel-brand-bg-basic-level-2',
	'BRAND_BG_LEVEL_3' = 'control-panel-brand-bg-basic-level-3',
	'BRAND_BG_TRANSPARENT_SEMI' = 'control-panel-brand-bg-basic-transparent-semi',
	'BRAND_BG_TRANSPARENT_FULL' = 'control-panel-brand-bg-basic-transparent-full',
