...
export interface DBSectionDefaultProps {
	/**
	 * The size attribute changes the padding-block of the container inside the section.
	 */
	size?: 'small' | 'medium' | 'large' | 'none';

	/**
	 * The variant attribute changes the padding-inline of the container inside the section.
	 */
