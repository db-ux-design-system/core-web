...
useMetadata({
	slots: {
		controlPanelDesktop: {
			...
			stencil:
				'<db-control-panel-desktop slot="controlPanelDesktop"><db-control-panel-brand slot="brand" data-logo="db-systel"></db-control-panel-brand><db-control-panel-meta slot="meta"><db-link href="#">Imprint</db-link><db-link href="#">Help</db-link></db-control-panel-meta><db-control-panel-actions-1 slot="actions-1"><db-button icon="magnifying_glass" variant="ghost" noText>Search</db-button></db-control-panel-actions-1><db-control-panel-actions-2 slot="actions-2"><db-button icon="x_placeholder" variant="ghost" noText>Profile</db-button><db-button icon="x_placeholder" variant="ghost" noText>Notification</db-button><db-button icon="x_placeholder" variant="ghost" noText>Help</db-button></db-control-panel-actions-2><db-control-panel-navigation><db-control-panel-navigation-item icon="x_placeholder"><a href="#">Navi-Item 1</a></db-control-panel-navigation-item><db-control-panel-navigation-item icon="x_placeholder" disabled><a href="#">Navi-Item 2</a></db-control-panel-navigation-item></db-control-panel-navigation></db-control-panel-desktop>',
