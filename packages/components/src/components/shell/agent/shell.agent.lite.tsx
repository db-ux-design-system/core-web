...
useMetadata({
	slots: {
		controlPanelDesktop: {
			angular:
				'<db-control-panel-desktop controlPanelDesktop><db-control-panel-brand brand data-logo="db-systel"></db-control-panel-brand><db-control-panel-meta meta><db-link href="#">Imprint</db-link><db-link href="#">Help</db-link></db-control-panel-meta><db-control-panel-actions-1 actions1><db-button icon="magnifying_glass" variant="ghost" noText>Search</db-button></db-control-panel-actions-1><db-control-panel-actions-2 actions2><db-button icon="x_placeholder" variant="ghost" noText>Profile</db-button><db-button icon="x_placeholder" variant="ghost" noText>Notification</db-button><db-button icon="x_placeholder" variant="ghost" noText>Help</db-button></db-control-panel-actions-2><db-control-panel-navigation><db-control-panel-navigation-item icon="x_placeholder"><a href="#">Navi-Item 1</a></db-control-panel-navigation-item><db-control-panel-navigation-item icon="x_placeholder" disabled><a href="#">Navi-Item 2</a></db-control-panel-navigation-item></db-control-panel-navigation></db-control-panel-desktop>',
			vue: '<DBControlPanelDesktop><template v-slot:brand><DBControlPanelBrand data-logo="db-systel" /></template><template v-slot:meta><DBLink href="#">Imprint</DBLink><DBLink href="#">Help</DBLink></template><template v-slot:actions1><DBButton icon="magnifying_glass" variant="ghost" noText>Search</DBButton></template><template v-slot:actions2><DBButton icon="x_placeholder" variant="ghost" noText>Profile</DBButton><DBButton icon="x_placeholder" variant="ghost" noText>Notification</DBButton><DBButton icon="x_placeholder" variant="ghost" noText>Help</DBButton></template><DBControlPanelNavigation><DBControlPanelNavigationItem icon="x_placeholder"><a href="#">Navi-Item 1</a></DBControlPanelNavigationItem><DBControlPanelNavigationItem icon="x_placeholder" disabled><a href="#">Navi-Item 2</a></DBControlPanelNavigationItem></DBControlPanelNavigation></DBControlPanelDesktop>',
			stencil:
				'<db-control-panel-desktop slot="controlPanelDesktop"><db-control-panel-brand slot="brand" data-logo="db-systel"></db-control-panel-brand><db-control-panel-meta slot="meta"><db-link href="#">Imprint</db-link><db-link href="#">Help</db-link></db-control-panel-meta><db-control-panel-actions-1 slot="actions1"><db-button icon="magnifying_glass" variant="ghost" noText>Search</db-button></db-control-panel-actions-1><db-control-panel-actions-2 slot="actions2"><db-button icon="x_placeholder" variant="ghost" noText>Profile</db-button><db-button icon="x_placeholder" variant="ghost" noText>Notification</db-button><db-button icon="x_placeholder" variant="ghost" noText>Help</db-button></db-control-panel-actions-2><db-control-panel-navigation><db-control-panel-navigation-item icon="x_placeholder"><a href="#">Navi-Item 1</a></db-control-panel-navigation-item><db-control-panel-navigation-item icon="x_placeholder" disabled><a href="#">Navi-Item 2</a></db-control-panel-navigation-item></db-control-panel-navigation></db-control-panel-desktop>',
			react: '<DBControlPanelDesktop brand={<DBControlPanelBrand data-logo="db-systel" />} meta={<><DBLink href="#">Imprint</DBLink><DBLink href="#">Help</DBLink></>} actions1={<DBButton icon="magnifying_glass" variant="ghost" noText>Search</DBButton>} actions2={<><DBButton icon="x_placeholder" variant="ghost" noText>Profile</DBButton><DBButton icon="x_placeholder" variant="ghost" noText>Notification</DBButton><DBButton icon="x_placeholder" variant="ghost" noText>Help</DBButton></>}><DBControlPanelNavigation><DBControlPanelNavigationItem icon="x_placeholder"><a href="#">Navi-Item 1</a></DBControlPanelNavigationItem><DBControlPanelNavigationItem icon="x_placeholder" disabled><a href="#">Navi-Item 2</a></DBControlPanelNavigationItem></DBControlPanelNavigation></DBControlPanelDesktop>'
		},
		controlPanelMobile: {
			angular:
