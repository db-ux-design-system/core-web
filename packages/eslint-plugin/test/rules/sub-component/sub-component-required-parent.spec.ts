...
describe('sub-component-required-parent', () => {
	...
	// DBDialogHeader / DBDialogFooter placement is covered comprehensively by the
	// "Dialog sub-components require a `DBDialog` ancestor" placement-shape tables
	// at the bottom of this file, so no hand-written block is kept here for them.
