		...
		invalid: [
			{
				...
				errors: [{messageId: 'textTooLong'}, {messageId: 'missingLabel'}],
				output:
			...
			},
			{
				...
				errors: [{messageId: 'textTooLong'}, {messageId: 'missingLabel'}],
				output:
					'<DBBadge placement="corner-top-right" text="123" label="1234" />',
			},
			{
				code: '<DBBadge placement="corner-bottom-left" label="Count">9999</DBBadge>',
				errors: [{messageId: 'textTooLong'}],
				output:
					'<DBBadge placement="corner-bottom-left" label="Count">999</DBBadge>',
			},
			{
		...
		invalid: [
			{
				...
				errors: [{messageId: 'textTooLong'}, {messageId: 'missingLabel'}],
				output:
					'<db-badge placement="corner-top-left" label="9999">9999</db-badge>',
			},
			{
				code: '<db-badge placement="corner-top-right">99</db-badge>',
				errors: [{messageId: 'missingLabel'}],
				output:
					'<db-badge placement="corner-top-right" label="99">99</db-badge>',
			},
		],
	});
});
