...
3. Adaptive Tokens standardmäßig verwenden. Ohne explizite Zuweisung bilden sie die Neutral-Farbpalette ab. Weitere Details befinden sich in der Datei [Adaptive Colors](../_principles/adaptive-colors.md).
