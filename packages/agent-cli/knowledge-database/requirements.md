...
Diese ID verbindet Dokumentation, Figma Komponenten, Code Komponenten, Storybook Stories und Plattformseiten.
...
Die Wissensbasis unterstützt folgende Arten von Design System Inhalten:

- **Foundations** — vorhanden
- **Components** — vorhanden
- **Patterns** — im Entstehen, wächst iterativ
- **Layout Guidelines** — in Arbeit (separater Branch, ggf. Umzug hierher)
- **Design Laws** — in Arbeit (separater Branch, ggf. Umzug hierher)
- **UX Writing** — tbd (Schreibregeln, Tonalität, Textkonventionen für UI-Texte)
- **Extensions** — vorhanden, aktuell nicht in der Database (nicht von Core Team verantwortet, Integration tbd)
- **Templates** — fix geplant, werden iterativ entstehen
