...
1. **sollte** pro Slot entweder Aktionen oder Umgebungsinformationen platzieren, nicht beides mischen.
2. Zuerst Actions 1 befüllen. Actions 2 zusätzlich verwenden, wenn die Aktionen inhaltlich oder hierarchisch aufgeteilt werden sollen. Actions 1 und Actions 2 können je nach Bedarf frei gewählt werden.
...
- Wenn beide Ausprägungen befüllt sind, trennt ein Divider Actions 1 und Actions 2 auf Desktop.
