...
2. `emphasis: weak` für dezente Trennung innerhalb eines Bereichs verwenden, `emphasis: strong` nur zwischen großen Abschnitten.
3. **sollte** Länge an den Inhaltsbereich anpassen und Ausrichtung konsistent halten.
