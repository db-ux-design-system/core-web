...
DB UX Design System is **white-label by default**. No additional theme package is required, but applications must import the built-in default theme CSS generated by the [Theme Builder](https://design-system.deutschebahn.com/theme-builder/).
...
For non-DB applications, import the built-in theme and the pre-layered component styles. Replace the theme import with a custom Theme Builder output when needed:
