import{_ as a}from"./custom-select-DAnZ6acb.js";import"./iframe-BRL77h7A.js";import"./preload-helper-BrSIRfC5.js";import"./constants-CvUrIGJS.js";import"./index-D_V5zbEX.js";import"./document-scroll-listener-DAKXbHx-.js";import"./floating-components-jmncKSnU.js";import"./form-components-CCMYuaqp.js";import"./button-foGc76eb.js";import"./infotext-COZFc5EN.js";import"./input-DmTapYuk.js";import"./tag-CH81OxFD.js";import"./tooltip-CauMDEGF.js";const{fn:g}=__STORYBOOK_MODULE_TEST__,f={title:"Components/DBCustomSelect/Density",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{options:{control:"object"},label:{control:"text"},placeholder:{control:"text"},id:{control:"text"},multiple:{control:"boolean"},variant:{control:"select",options:["above","floating"]},values:{control:"object"},showLabel:{control:"boolean"},message:{control:"text"},showMessage:{control:"boolean"},showIcon:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},invalidMessage:{control:"text"},validMessage:{control:"text"},required:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},disabled:{control:"boolean"},name:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},formFieldWidth:{control:"select",options:["full","auto"]},dropdownWidth:{control:"select",options:["auto","fixed"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end"]},selectedType:{control:"select",options:["amount","text","tag"]},showNoResults:{control:"boolean"},noResultsText:{control:"text"},showLoading:{control:"boolean"},loadingText:{control:"text"},showSearch:{control:"boolean"},showSelectAll:{control:"boolean"},showClearSelection:{control:"boolean"},removeTagsTexts:{control:"object"},searchValue:{control:"text"},searchLabel:{control:"text"},searchPlaceholder:{control:"text"},selectedLabels:{control:"text"},selectedPrefix:{control:"text"},selectAllLabel:{control:"text"},listLabel:{control:"text"},clearSelectionText:{control:"text"},amountText:{control:"text"},mobileCloseButtonText:{control:"text"},open:{control:"boolean"},autofocus:{control:"boolean"}}},t={args:{"data-density":"functional",placeholder:"Placeholder",label:"Functional",listLabel:"id-10206-Functional",options:[{value:"Option 1",id:"miouzc0ec"},{value:"Option 2",id:"10dqnhil2"},{value:"Option 3",id:"10dqnhil3"},{value:"Option 4",id:"10dqnhil4"},{value:"Option 5",id:"10dqnhil5"}],default:""},render:e=>({components:{DBCustomSelect:a},setup(){return{args:e}},template:`<div  :style="{
  width: '200px'
