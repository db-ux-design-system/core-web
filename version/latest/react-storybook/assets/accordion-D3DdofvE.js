import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{f as t}from"./iframe-BBVbVwRb.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{C as r,S as i,_ as a,r as o,w as s}from"./utils-D4k_irbm.js";import{n as c,t as l}from"./accordion-item-CCsY2N5G.js";function u(e,t){let n=(0,f.useId)(),a=t||(0,d.useRef)(t),[s,c]=(0,d.useState)(()=>``),[u,m]=(0,d.useState)(()=>!1),[h,g]=(0,d.useState)(()=>!1);function _(){try{return typeof e.items==`string`?JSON.parse(e.items):e.items}catch(e){console.error(e)}return[]}return(0,d.useEffect)(()=>{m(!0),g(!0)},[]),(0,d.useEffect)(()=>{u&&a.current&&(e.behavior===`single`?e.name?s!==e.name&&c(e.name):c(`accordion-${n}`):c(``))},[u,e.name,e.behavior]),(0,d.useEffect)(()=>{if(a.current){let e=a.current.getElementsByTagName(`details`);if(e)for(let t of Array.from(e))s===``?t.removeAttribute(`name`):t.name=s??``}},[a.current,s]),(0,d.useEffect)(()=>{if(a.current&&h){if(e?.initOpenIndex&&e.initOpenIndex.length>0){let t=a.current.getElementsByTagName(`details`);if(t){let n=e.behavior===`single`&&e.initOpenIndex.length>1?[e.initOpenIndex[0]]:e.initOpenIndex;Array.from(t).forEach((e,t)=>{n?.includes(t)&&(e.open=!0)})}}g(!1)}},[a.current,h,e.initOpenIndex]),(0,p.jsxs)(`ul`,{ref:a,...i(e,[`data-icon-variant`,`data-icon-variant-before`,`data-icon-variant-after`,`data-icon-weight`,`data-icon-weight-before`,`data-icon-weight-after`,`data-interactive`,`data-force-mobile`,`data-color`,`data-container-color`,`data-bg-color`,`data-on-bg-color`,`data-color-scheme`,`data-font-size`,`data-headline-size`,`data-divider`,`data-focus`,`data-font`,`data-density`]),id:e.id??e.propOverrides?.id,...r(e,[`data-icon-variant`,`data-icon-variant-before`,`data-icon-variant-after`,`data-icon-weight`,`data-icon-weight-before`,`data-icon-weight-after`,`data-interactive`,`data-force-mobile`,`data-color`,`data-container-color`,`data-bg-color`,`data-on-bg-color`,`data-color-scheme`,`data-font-size`,`data-headline-size`,`data-divider`,`data-focus`,`data-font`,`data-density`]),className:o(`db-accordion`,e.className),"data-variant":e.variant,children:[e.items?null:(0,p.jsx)(p.Fragment,{children:e.children}),e.items?(0,p.jsx)(p.Fragment,{children:_()?.map((e,t)=>(0,p.jsx)(l,{headlinePlain:e.headlinePlain,disabled:e.disabled,text:e.text},`accordion-item-${t}`))}):null]})}var d,f,p,m;function h(){return(h=e((()=>{t(),s(),d=t(),a(),c(),f=t(),p=n(),m=(0,d.forwardRef)(u),m.__docgenInfo={description:``,methods:[],displayName:`DBAccordion`,props:{initOpenIndex:{required:!1,tsType:{name:`Array`,elements:[{name:`number`}],raw:`number[]`},description:`The index of items which should be open when loading the accordion`},items:{required:!1,tsType:{name:`union`,raw:`DBAccordionItemDefaultProps[] | string`,elements:[{name:`Array`,elements:[{name:`intersection`,raw:`{
  /**
