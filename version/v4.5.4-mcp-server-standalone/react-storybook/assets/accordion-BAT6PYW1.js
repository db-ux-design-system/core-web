import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as b,g as y,f as v}from"./index-D2E5Z_bU.js";import{r as t}from"./iframe-DqPoox06.js";import{D as w}from"./accordion-item-C1Nu4oRH.js";function T(e,d){const f=t.useId(),a=d||t.useRef(d),[o,s]=t.useState(()=>""),[l,u]=t.useState(()=>!1),[c,m]=t.useState(()=>!1);function h(){try{return typeof e.items=="string"?JSON.parse(e.items):e.items}catch(n){console.error(n)}return[]}return t.useEffect(()=>{u(!0),m(!0)},[]),t.useEffect(()=>{l&&(e.behavior==="single"?e.name?o!==e.name&&s(e.name):s(`accordion-${f}`):s(""))},[l,e.name,e.behavior]),t.useEffect(()=>{if(a.current){const n=a.current.getElementsByTagName("details");if(n)for(const i of Array.from(n))o===""?i.removeAttribute("name"):i.name=o??""}},[a.current,o]),t.useEffect(()=>{if(a.current&&c){if(e?.initOpenIndex&&e.initOpenIndex.length>0){const n=a.current.getElementsByTagName("details");if(n){const i=e.behavior==="single"&&e.initOpenIndex.length>1?[e.initOpenIndex[0]]:e.initOpenIndex;Array.from(n).forEach((g,p)=>{i?.includes(p)&&(g.open=!0)})}}m(!1)}},[a.current,c,e.initOpenIndex]),r.jsxs("ul",{ref:a,...v(e,["data-icon-variant","data-icon-variant-before","data-icon-variant-after","data-icon-weight","data-icon-weight-before","data-icon-weight-after","data-interactive","data-force-mobile","data-color","data-container-color","data-bg-color","data-on-bg-color","data-color-scheme","data-font-size","data-headline-size","data-divider","data-focus","data-font","data-density"]),id:e.id??e.propOverrides?.id,...y(e,["data-icon-variant","data-icon-variant-before","data-icon-variant-after","data-icon-weight","data-icon-weight-before","data-icon-weight-after","data-interactive","data-force-mobile","data-color","data-container-color","data-bg-color","data-on-bg-color","data-color-scheme","data-font-size","data-headline-size","data-divider","data-focus","data-font","data-density"]),className:b("db-accordion",e.className),"data-variant":e.variant,children:[e.items?null:r.jsx(r.Fragment,{children:e.children}),e.items?r.jsx(r.Fragment,{children:h()?.map((n,i)=>r.jsx(w,{headlinePlain:n.headlinePlain,disabled:n.disabled,text:n.text},`accordion-item-${i}`))}):null]})}const x=t.forwardRef(T);x.__docgenInfo={description:"",methods:[],displayName:"DBAccordion",props:{behavior:{required:!1,tsType:{name:"unknown[number]",raw:"(typeof AccordionBehaviorList)[number]"},description:"To allow multiple items open at the same time or only 1 item"},initOpenIndex:{required:!1,tsType:{name:"Array",elements:[{name:"number"}],raw:"number[]"},description:"The index of items which should be open when loading the accordion"},items:{required:!1,tsType:{name:"union",raw:"DBAccordionItemDefaultProps[] | string",elements:[{name:"Array",elements:[{name:"intersection",raw:`{
  /**
