import{j as a}from"./jsx-runtime-u17CrQMm.js";import{D as r}from"./button-CMF91ZdE.js";import"./index-D2E5Z_bU.js";import"./iframe-BhiBouzR.js";import"./preload-helper-BHRuClfA.js";const{fn:t}=__STORYBOOK_MODULE_TEST__,d={title:"Components/DBButton/Show Icon Trailing",component:r,parameters:{layout:"centered"},tags:["autodocs"],args:{onClick:t()},argTypes:{variant:{control:"select",options:["outlined","brand","ghost","filled"]},disabled:{control:"boolean"},form:{control:"text"},name:{control:"text"},noText:{control:"boolean"},wrap:{control:"boolean"},type:{control:"select",options:["button","reset","submit"]},value:{control:"text"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},width:{control:"select",options:["full","auto"]},size:{control:"select",options:["small","medium"]},text:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},o={args:{iconTrailing:"x_placeholder",onClick:t(),showIconTrailing:!1,children:"(Default) False"},render:n=>a.jsx(r,{...n})},e={args:{iconTrailing:"x_placeholder",onClick:t(),showIconTrailing:!0,children:"True"},render:n=>a.jsx(r,{...n})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
