import{f as e,n as t}from"./iframe-COzDI3Sm.js";import{C as n,T as r,_ as i,r as a,w as o}from"./utils-BQkyulTo.js";import{n as s,t as c}from"./accordion-item-BLz9xECP.js";import{n as l}from"./rolldown-runtime-DkW27tQK.js";function u(e,t){let r=(0,f.useId)(),i=t||(0,d.useRef)(t),[s,l]=(0,d.useState)(()=>``),[u,m]=(0,d.useState)(()=>!1),[h,g]=(0,d.useState)(()=>!1);function _(){try{return typeof e.items==`string`?JSON.parse(e.items):e.items}catch(e){console.error(e)}return[]}return(0,d.useEffect)(()=>{m(!0),g(!0)},[]),(0,d.useEffect)(()=>{u&&i.current&&(e.behavior===`single`?e.name?s!==e.name&&l(e.name):l(`accordion-${r}`):l(``))},[u,e.name,e.behavior]),(0,d.useEffect)(()=>{if(i.current){let e=i.current.getElementsByTagName(`details`);if(e)for(let t of Array.from(e))s===``?t.removeAttribute(`name`):t.name=s??``}},[i.current,s]),(0,d.useEffect)(()=>{if(i.current&&h){if(e?.initOpenIndex&&e.initOpenIndex.length>0){let t=i.current.getElementsByTagName(`details`);if(t){let n=e.behavior===`single`&&e.initOpenIndex.length>1?[e.initOpenIndex[0]]:e.initOpenIndex;Array.from(t).forEach((e,t)=>{n?.includes(t)&&(e.open=!0)})}}g(!1)}},[i.current,h,e.initOpenIndex]),(0,p.jsxs)(`ul`,{ref:i,...n(e,[`data-icon-variant`,`data-icon-variant-before`,`data-icon-variant-after`,`data-icon-weight`,`data-icon-weight-before`,`data-icon-weight-after`,`data-interactive`,`data-force-mobile`,`data-color`,`data-container-color`,`data-bg-color`,`data-on-bg-color`,`data-color-scheme`,`data-font-size`,`data-headline-size`,`data-divider`,`data-focus`,`data-font`,`data-density`]),id:e.id??e.propOverrides?.id,...o(e,[`data-icon-variant`,`data-icon-variant-before`,`data-icon-variant-after`,`data-icon-weight`,`data-icon-weight-before`,`data-icon-weight-after`,`data-interactive`,`data-force-mobile`,`data-color`,`data-container-color`,`data-bg-color`,`data-on-bg-color`,`data-color-scheme`,`data-font-size`,`data-headline-size`,`data-divider`,`data-focus`,`data-font`,`data-density`]),className:a(`db-accordion`,e.className),"data-variant":e.variant,children:[e.items?null:(0,p.jsx)(p.Fragment,{children:e.children}),e.items?(0,p.jsx)(p.Fragment,{children:_()?.map((e,t)=>(0,p.jsx)(c,{headlinePlain:e.headlinePlain,disabled:e.disabled,text:e.text},`accordion-item-${t}`))}):null]})}var d,f,p,m;function h(){return(h=l((()=>{e(),r(),d=e(),i(),s(),f=e(),p=t(),m=(0,d.forwardRef)(u),m.__docgenInfo={description:``,methods:[],displayName:`DBAccordion`,props:{initOpenIndex:{required:!1,tsType:{name:`Array`,elements:[{name:`number`}],raw:`number[]`},description:`The index of items which should be open when loading the accordion`},items:{required:!1,tsType:{name:`union`,raw:`DBAccordionItemDefaultProps[] | string`,elements:[{name:`Array`,elements:[{name:`intersection`,raw:`{
  /**
...
@default 'multiple'`}}}})))()}export{h as n,m as t};