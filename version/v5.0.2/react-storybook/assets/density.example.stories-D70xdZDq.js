import{i as e}from"./preload-helper-CpAADj-T.js";import{t}from"./jsx-runtime-CW49yT46.js";import{S as n,t as r,w as i}from"./src-CYPjw6XY.js";var a,o,s,c,l,u,d;e((()=>{r(),a=t(),{fn:o}=__STORYBOOK_MODULE_TEST__,s={title:`Components/DBTabItem/Density`,component:i,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{label:{control:`text`},active:{control:`boolean`},disabled:{control:`boolean`},showIcon:{control:`boolean`},showIconLeading:{control:`boolean`},showIconTrailing:{control:`boolean`},autofocus:{control:`boolean`}}},c={args:{label:`Functional`},render:e=>(0,a.jsx)(n,{"data-density":`functional`,children:(0,a.jsx)(i,{...e})})},l={args:{label:`(Default) Regular`},render:e=>(0,a.jsx)(n,{children:(0,a.jsx)(i,{...e})})},u={args:{label:`Expressive`},render:e=>(0,a.jsx)(n,{"data-density":`expressive`,children:(0,a.jsx)(i,{...e})})},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    "label": "Functional"
  },
