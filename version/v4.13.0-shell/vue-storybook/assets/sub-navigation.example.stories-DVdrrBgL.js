import{i as e}from"./preload-helper-BfXGMw9-.js";import{Bt as t,F as n,Mt as r,N as i,Ot as a,ct as o,ft as s,gt as c,j as l,mt as u,ot as d,q as f,t as p,ut as m,wt as h}from"./src-D7kPOHCd.js";var g,_,v,y,b,x,S;e((()=>{p(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={title:`Components/DBShell/Sub Navigation`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},v={args:{"data-test-id":`shell-top-sub-top`,controlPanelDesktopPosition:`top`,subNavigationDesktopPosition:`top`,showSubNavigation:!0,default:`<DBControlPanelDesktop
