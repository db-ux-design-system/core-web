...
><DBTableFooter
  ...
  ></DBTableFooter
>`},render:e=>({components:{DBTable:s,DBInfotext:t,DBTableBody:o,DBTableDataCell:l,DBTableFooter:r,DBTableHead:a,DBTableHeaderCell:n,DBTableRow:i},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
