...
>`},render:e=>({components:{DBDrawer:i,DBButton:t,DBDrawerHeader:n},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},u={args:{backdrop:`none`,open:!1,onClose:a(),default:`No Backdrop<template v-slot:header
  ><DBDrawerHeader>No Backdrop</DBDrawerHeader></template
>`},render:e=>({components:{DBDrawer:i,DBButton:t,DBDrawerHeader:n},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "backdrop": "strong",
    "open": false,
    "onClose": fn(),
