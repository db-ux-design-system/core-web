import{i as e}from"./preload-helper-BfXGMw9-.js";import{Bt as t,F as n,Mt as r,N as i,Ot as a,ct as o,ft as s,gt as c,mt as l,ot as u,q as d,t as f,wt as p}from"./src-D7kPOHCd.js";var m,h,g,_,v;e((()=>{f(),{fn:m}=__STORYBOOK_MODULE_TEST__,h={title:`Components/DBShell/Position`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},g={args:{"data-test-id":`shell-position-top`,controlPanelDesktopPosition:`top`,default:`<DBControlPanelDesktop
