import{j as t}from"./jsx-runtime-u17CrQMm.js";import{D as a,a as s}from"./tab-list-DRUsJJG6.js";import"./index-C0vvPcr0.js";import"./iframe-Bxc-Wp-Z.js";import"./preload-helper-Dalyj7-T.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:"Components/DBTabItem/Behavior",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},noText:{control:"boolean"},checked:{control:"boolean"},name:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},o={args:{label:"(Default) Auto Width"},render:r=>t.jsx(s,{children:t.jsx(a,{...r})})},e={args:{label:"Width full"},render:r=>t.jsx(s,{style:{blockSize:"100%"},children:t.jsx(a,{...r})})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
