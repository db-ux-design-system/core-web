import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as a}from"./badge-BAo0XzoB.js";import{D as s}from"./icon-BViUtxN1.js";import"./index-C0vvPcr0.js";import"./iframe-Bxc-Wp-Z.js";import"./preload-helper-Dalyj7-T.js";import"./constants-C-ysBZRi.js";const{fn:u}=__STORYBOOK_MODULE_TEST__,x={title:"Components/DBBadge/Content",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{emphasis:{control:"select",options:["weak","strong"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},size:{control:"select",options:["small","medium"]},placement:{control:"select",options:["inline","corner-top-left","corner-top-right","corner-center-left","corner-center-right","corner-bottom-left","corner-bottom-right"]},label:{control:"text"},text:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},r={args:{children:"(Default) Text"},render:e=>n.jsx(a,{...e})},o={args:{},render:e=>n.jsx(a,{...e})},t={args:{semantic:"critical",emphasis:"strong",children:n.jsx(s,{icon:"x_placeholder",children:"Icon - Small"})},render:e=>n.jsx(a,{...e})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
