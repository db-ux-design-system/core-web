import{_ as a,a as n,b as B,c as r,d as b,e as i}from"./table-CtpEpGnb.js";import{_ as T}from"./tooltip-CVyBLrnK.js";import{_ as c}from"./tag-D6GpvTvK.js";import{_ as C}from"./link-fC-rbOVn.js";import{_ as s}from"./input-BNgfnzki.js";import{_ as d}from"./infotext-xNlp78Fe.js";import{_ as p}from"./checkbox-CEiv3pGr.js";import{_ as f}from"./button-Dpt4AHYT.js";import"./iframe-DfX-y39i.js";import"./preload-helper-MpUUyRtn.js";import"./index-DonnAjIC.js";import"./constants-BMPlMwqI.js";import"./document-scroll-listener-C7iMKSof.js";import"./floating-components-1F_x7pmN.js";import"./form-components-BfcLK2Tl.js";const{fn:M}=__STORYBOOK_MODULE_TEST__,A={title:"Components/DBTable/Complex",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{id:{control:"text"}}},l={args:{captionPlain:"Joined, sortable columns are Link.",default:`<DBTableHead
  ><DBTableRow
    ><DBTableHeaderCell
  ...
  gap: 'var(--db-spacing-fixed-xs)'
    ...
    ><DBTableHeaderCell horizontalAlignment="end" :noText="true">
      Button
...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:a,DBButton:f,DBCheckbox:p,DBInfotext:d,DBInput:s,DBLink:C,DBTableBody:i,DBTableDataCell:b,DBTableHead:r,DBTableHeaderCell:B,DBTableRow:n,DBTag:c,DBTooltip:T},setup(){return{args:e}},template:`<div  :style="{
  inlineSize: '100%',
  display: 'flex',
...
>`},render:e=>({components:{DBTable:a,DBButton:f,DBCheckbox:p,DBInfotext:d,DBInput:s,DBLink:C,DBTableBody:i,DBTableDataCell:b,DBTableHead:r,DBTableHeaderCell:B,DBTableRow:n,DBTag:c,DBTooltip:T},setup(){return{args:e}},template:`<div  :style="{
  ...
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    Zebra
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},D={args:{variant:"floating",captionPlain:"Floating, sortable columns are Link.",default:`<DBTableHead
  ><DBTableRow
    ><DBTableHeaderCell
...
>`},render:e=>({components:{DBTable:a,DBButton:f,DBCheckbox:p,DBInfotext:d,DBInput:s,DBLink:C,DBTableBody:i,DBTableDataCell:b,DBTableHead:r,DBTableHeaderCell:B,DBTableRow:n,DBTag:c,DBTooltip:T},setup(){return{args:e}},template:`<div  :style="{
  ...
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    Floating
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},o={args:{variant:"floating",mobileVariant:"list",captionPlain:"Mobile variant: List, sortable columns are Link.",default:`<DBTableHead
  ><DBTableRow
    ><DBTableHeaderCell
...
}`,...o.parameters?.docs?.source}}};const Y=["Joined","Floating","MobilevariantList","TableComplex3"];export{t as Floating,l as Joined,D as MobilevariantList,o as TableComplex3,Y as __namedExportsOrder,A as default};
