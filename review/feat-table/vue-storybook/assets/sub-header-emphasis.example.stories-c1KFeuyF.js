import{s,c as r,e as l}from"./data-ntzduIQ0.js";import{_ as i}from"./infotext-DS50ep4B.js";import{e as o}from"./table-DbA6HBI4.js";import"./iframe-BWB3vTMe.js";import"./preload-helper-MpUUyRtn.js";import"./index-COCtms_G.js";import"./link-6tOfbsYC.js";const{fn:g}=__STORYBOOK_MODULE_TEST__,D={title:"Components/DBTable/SubHeaderEmphasis",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{id:{control:"text"},caption:{control:"text"},captionPlain:{control:"text"},data:{control:"object"},divider:{control:"select",options:["none","both","horizontal","vertical"]},showCaption:{control:"boolean"},size:{control:"select",options:["x-small","small","medium","large"]},variant:{control:"select",options:["joined","zebra","floating"]},mobileVariant:{control:"select",options:["table","list"]},stickyHeader:{control:"select",options:["none","both","horizontal","vertical"]},columnSizes:{control:"object"}}},a={args:{captionPlain:"(Default) None",data:s,default:""},render:e=>({components:{DBTable:o,DBInfotext:i},setup(){return{args:e}},template:`<div  :style="{
  ...
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    (Default) None
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},t={args:{captionPlain:"Weak",data:l,default:""},render:e=>({components:{DBTable:o,DBInfotext:i},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    Weak
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},n={args:{captionPlain:"Strong",data:r,default:""},render:e=>({components:{DBTable:o,DBInfotext:i},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
