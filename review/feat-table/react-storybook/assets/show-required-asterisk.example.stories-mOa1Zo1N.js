import{j as s}from"./jsx-runtime-u17CrQMm.js";import{D as t}from"./radio-fhjkMlav.js";import"./index-C0vvPcr0.js";import"./iframe-D80j_IDB.js";import"./preload-helper-BD8fvMO7.js";import"./form-components-DI5fDEQF.js";const{fn:u}=__STORYBOOK_MODULE_TEST__,m={title:"Components/DBRadio/Show Required Asterisk",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{name:{control:"text"},value:{control:"text"},disabled:{control:"boolean"},checked:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},size:{control:"select",options:["small","medium"]},required:{control:"boolean"},showLabel:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},label:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{name:"Asterisk",required:!0,showRequiredAsterisk:!0,children:"(Default) True"},render:o=>s.jsx(t,{...o})},r={args:{name:"Asterisk",required:!0,showRequiredAsterisk:!1,children:"False"},render:o=>s.jsx(t,{...o})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    "name": "Asterisk",
    "required": true,
