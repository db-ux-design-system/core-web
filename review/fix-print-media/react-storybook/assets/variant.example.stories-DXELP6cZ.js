import{j as t}from"./jsx-runtime-u17CrQMm.js";import{D as o}from"./divider-jef8zMYX.js";import{D as i}from"./infotext-gZMLPV8V.js";import"./index-D2E5Z_bU.js";import"./iframe-D9hHgFwO.js";import"./preload-helper-FrTVO4j9.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,f={title:"Components/DBDivider/Variant",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{width:{control:"select",options:["full","auto"]},variant:{control:"select",options:["horizontal","vertical"]},emphasis:{control:"select",options:["weak","strong"]},margin:{control:"select",options:["medium","small","large","none","_"]},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{width:"full"},render:a=>t.jsxs("div",{style:{width:"200px"},children:[t.jsx(i,{size:"small",semantic:"informational",children:"(Default) Adaptive - Horizontal"}),t.jsx(o,{...a})]})},r={args:{variant:"vertical",width:"full"},render:a=>t.jsxs("div",{style:{height:"100px"},children:[t.jsx(i,{size:"small",semantic:"informational",children:"Adaptive - Vertical"}),t.jsx(o,{...a})]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    "width": "full"
  },
