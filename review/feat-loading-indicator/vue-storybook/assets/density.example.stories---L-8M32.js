...
><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:r,DBInfotext:n},setup(){return{args:e}},template:`<div data-density="expressive" :style="{
  ...
  width: '200px'
                    ...
                    Expressive
                </DBInfotext><DBStack v-bind="args"   >${e.default}</DBStack></div>`})},u=[`Functional`,`DefaultRegular`,`Expressive`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "style": {
