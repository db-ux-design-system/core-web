import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./infotext-hxInthQR.js";import{n as r,t as i}from"./control-panel-brand-GPdtJf9f.js";var a,o,s,c,l,u;function d(){return(d=e((()=>{t(),r(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBControlPanelBrand/Variants`,component:i,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{id:{control:`text`},autofocus:{control:`boolean`}}},s={args:{default:`Functional`},render:e=>({components:{DBControlPanelBrand:i,DBInfotext:n},setup(){return{args:e}},template:`<div    ><DBInfotext semantic="informational" size="small" icon="none"   >
                    (Default) With Logo
