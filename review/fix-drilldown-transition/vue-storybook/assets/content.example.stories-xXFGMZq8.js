...
>`},render:e=>({components:{DBTable:u,DBInfotext:n,DBTableBody:i,DBTableDataCell:l,DBTableFooter:d,DBTableHead:s,DBTableHeaderCell:o,DBTableRow:g},setup(){return{args:e}},template:`<div  :style="{
  ...
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    Composition
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},C=[`Data`,`Composition`],x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    "captionPlain": "Data",
    "data": defaultTable,
    "default": \`\`
...
}`,...S.parameters?.docs?.source}}}})))()}w();export{S as Composition,x as Data,C as __namedExportsOrder,b as default};