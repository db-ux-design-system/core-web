import{i as e}from"./preload-helper-DuFnYJwC.js";import{t}from"./jsx-runtime-BN51nq8X.js";import{mt as n,t as r}from"./src-D0QCgE56.js";var i,a,o,s,c,l;e((()=>{r(),i=t(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBCard/Behavior`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClick:a()},argTypes:{behavior:{control:`select`,options:[`static`,`interactive`]},elevationLevel:{control:`select`,options:[`1`,`2`,`3`]},spacing:{control:`select`,options:[`medium`,`small`,`large`,`none`]},id:{control:`text`},autofocus:{control:`boolean`},onClick:{action:`onClick`}}},s={args:{behavior:`static`,children:(0,i.jsx)(`strong`,{children:`(Default) Static`})},render:e=>(0,i.jsx)(n,{...e})},c={args:{behavior:`interactive`,children:(0,i.jsx)(`strong`,{children:`Interactive`})},render:e=>(0,i.jsx)(`button`,{type:`button`,children:(0,i.jsx)(n,{...e})})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "behavior": "static",
