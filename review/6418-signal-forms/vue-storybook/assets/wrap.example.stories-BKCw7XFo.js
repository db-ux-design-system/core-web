...
><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:n,DBInfotext:t},setup(){return{args:e}},template:`<div  :style="{
  ...
  height: '88px'
                    ...
                    No Wrap: Row
                </DBInfotext><DBStack v-bind="args"   >${e.default}</DBStack></div>`})},c={args:{style:{padding:`var(--db-spacing-fixed-xs)`},wrap:!0,default:`<span class="dummy-component"><a href="#">Content 1</a></span
><span class="dummy-component">Content 2</span
><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:n,DBInfotext:t},setup(){return{args:e}},template:`<div  :style="{
  alignItems: 'flex-start',
  alignSelf: 'flex-start',
  ...
  height: '120px'
                    ...
                    Wrap: Column
                </DBInfotext><DBStack v-bind="args"   >${e.default}</DBStack></div>`})},l={args:{direction:`row`,style:{padding:`var(--db-spacing-fixed-xs)`},wrap:!0,default:`<span class="dummy-component"><a href="#">Content 1</a></span
><span class="dummy-component">Content 2</span
><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:n,DBInfotext:t},setup(){return{args:e}},template:`<div  :style="{
  alignItems: 'flex-start',
  alignSelf: 'flex-start',
...
}`,...l.parameters?.docs?.source}}},u=[`DefaultNoWrapColumn`,`NoWrapRow`,`WrapColumn`,`WrapRow`]}))();export{o as DefaultNoWrapColumn,s as NoWrapRow,c as WrapColumn,l as WrapRow,u as __namedExportsOrder,a as default};