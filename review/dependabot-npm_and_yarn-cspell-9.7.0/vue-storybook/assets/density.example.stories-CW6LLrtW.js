import{_ as o}from"./navigation-item-SbghKoE_.js";import"./iframe-Bu8DqMMG.js";import"./preload-helper-CSJ1qRbl.js";import"./constants-y2N5m1XS.js";import"./index-Bpz0UvTb.js";import"./floating-components-CKmcRn_b.js";import"./button-B9asPu46.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,p={title:"Components/DBNavigationItem/Density",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{disabled:{control:"boolean"},active:{control:"boolean"},showIcon:{control:"boolean"},width:{control:"select",options:["full","auto"]},wrap:{control:"boolean"},text:{control:"text"},subNavigationExpanded:{control:"boolean"},backButtonId:{control:"text"},backButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},e={args:{"data-density":"functional",default:'<a href="#">Functional</a>'},render:t=>({components:{DBNavigationItem:o},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},a={args:{"data-density":"regular",default:'<a href="#">(Default) Regular</a>'},render:t=>({components:{DBNavigationItem:o},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},n={args:{"data-density":"expressive",default:'<a href="#">Expressive</a>'},render:t=>({components:{DBNavigationItem:o},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
