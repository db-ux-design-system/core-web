import{i as e}from"./preload-helper-psR5L3ql.js";import{D as t,P as n,it as r,j as i,k as a,nt as o,t as s}from"./src-2Szyyklt.js";var c,l,u,d,f;e((()=>{s(),{fn:c}=__STORYBOOK_MODULE_TEST__,l={title:`Components/DBHeader/Behavior`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},drawerOpen:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},u={args:{default:`<DBNavigation aria-label="Desktop (full width)" v-bind="{}"
