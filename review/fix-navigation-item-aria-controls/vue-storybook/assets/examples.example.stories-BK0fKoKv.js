import{_ as o}from"./navigation-D8nnYyO6.js";import{_ as d}from"./navigation-item-CgLA0weJ.js";import{_ as l}from"./brand-BHTbUAHv.js";import{_ as e}from"./header-DcU5NAC-.js";import"./iframe-D72wlKJ3.js";import"./preload-helper-4IfGN77o.js";import"./index-BJ0BZHZI.js";import"./constants-y2N5m1XS.js";import"./floating-components-CKmcRn_b.js";import"./button-BX2aeSHn.js";import"./drawer-ChlTRjij.js";const{fn:h}=__STORYBOOK_MODULE_TEST__,f={title:"Components/DBHeader/Examples",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{width:{control:"select",options:["full","medium","large","small"]},forceMobile:{control:"boolean"},drawerOpen:{control:"boolean"},burgerMenuLabel:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},t={args:{default:`<DBNavigation ariaLabel="Navigation - With Application Name" v-bind="{}"
...
><template v-slot:brand><DBBrand>DBHeader</DBBrand></template>`},render:a=>({components:{DBHeader:e,DBBrand:l,DBNavigationItem:d,DBNavigation:o},setup(){return{args:a}},template:`<div  :style="{
  ...
  width: '100%',
  display: 'block'
}"  ><DBHeader v-bind="args"   >${a.default}</DBHeader></div>`})},i={args:{default:`<DBNavigation ariaLabel="Navigation - Without Application Name" v-bind="{}"
  ><DBNavigationItem icon="x_placeholder"
...
><template v-slot:brand><DBBrand></DBBrand></template>`},render:a=>({components:{DBHeader:e,DBBrand:l,DBNavigationItem:d,DBNavigation:o},setup(){return{args:a}},template:`<div  :style="{
  ...
  args: {
    "default": \`<DBNavigation ariaLabel="Navigation - With Application Name" v-bind="{}"
  ><DBNavigationItem icon="x_placeholder"
    ><a href="#">With Application Name + Navigation</a></DBNavigationItem
  ><DBNavigationItem :disabled="true"
    ><a href="#">
...
><template v-slot:brand><DBBrand>DBHeader</DBBrand></template>\`
  ...
  args: {
    "default": \`<DBNavigation ariaLabel="Navigation - Without Application Name" v-bind="{}"
  ><DBNavigationItem icon="x_placeholder"
    ><a href="#">Without Application Name</a></DBNavigationItem
  ><DBNavigationItem :disabled="true"
    ><a href="#">Without Application Name disabled</a></DBNavigationItem
