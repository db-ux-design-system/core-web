...
>`},render:e=>({components:{DBDrawer:r,DBButton:n,DBDrawerHeader:t,DBInfotext:i},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},u={args:{containerSize:`large`,direction:`to-left`,open:!1,onClose:o(),default:`Large<template v-slot:header
  ><DBDrawerHeader closeButtonText="Close"> Large </DBDrawerHeader></template
>`},render:e=>({components:{DBDrawer:r,DBButton:n,DBDrawerHeader:t,DBInfotext:i},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},d={args:{containerSize:`full`,direction:`to-left`,open:!1,onClose:o(),default:`Full<template v-slot:header
  ><DBDrawerHeader closeButtonText="Close"> Full </DBDrawerHeader></template
>`},render:e=>({components:{DBDrawer:r,DBButton:n,DBDrawerHeader:t,DBInfotext:i},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},f={args:{containerSize:`small`,direction:`up`,open:!1,onClose:o(),default:`Small (Up)<template v-slot:header
  ><DBDrawerHeader closeButtonText="Close">
    Small (Up)
  </DBDrawerHeader></template
