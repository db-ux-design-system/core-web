import{_ as n}from"./tag-Fqj8OwqX.js";import"./iframe-BN-xew0d.js";import"./preload-helper-DkqIV-n9.js";import"./constants-y2N5m1XS.js";import"./index-CejtAwlY.js";import"./tooltip-BXwsDRR7.js";import"./document-scroll-listener-DEOyNZhE.js";import"./floating-components-CKmcRn_b.js";const{fn:i}=__STORYBOOK_MODULE_TEST__,g={title:"Components/DBTag/Show Check State",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{emphasis:{control:"select",options:["weak","strong"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},behavior:{control:"select",options:["static","removable"]},showIcon:{control:"boolean"},noText:{control:"boolean"},content:{control:"text"},showCheckState:{control:"boolean"},overflow:{control:"boolean"},removeButton:{control:"text"},text:{control:"text"},value:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onRemove:{action:"onRemove"}}},t={args:{showCheckState:!0,default:`<label
  ><input type="checkbox" />
  (Default) True
