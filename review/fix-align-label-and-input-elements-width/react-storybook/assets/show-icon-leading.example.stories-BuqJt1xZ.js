import{i as e}from"./preload-helper-Czh2F1ab.js";import{t}from"./jsx-runtime-Bmr7cA1B.js";import{a as n,o as r,t as i}from"./src-DImxzT_Y.js";var a,o,s,c,l,u;e((()=>{i(),a=t(),{fn:o}=__STORYBOOK_MODULE_TEST__,s={title:`Components/DBTabItem/Show Icon Leading`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{label:{control:`text`},active:{control:`boolean`},disabled:{control:`boolean`},showIcon:{control:`boolean`},showIconLeading:{control:`boolean`},showIconTrailing:{control:`boolean`},noText:{control:`boolean`},checked:{control:`boolean`},name:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},c={args:{label:`(Default) False`,icon:`x_placeholder`,showIcon:!1},render:e=>(0,a.jsx)(n,{children:(0,a.jsx)(r,{...e})})},l={args:{label:`True`,icon:`x_placeholder`,showIcon:!0},render:e=>(0,a.jsx)(n,{children:(0,a.jsx)(r,{...e})})},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    "label": "(Default) False",
    "icon": "x_placeholder",
    "showIcon": false
