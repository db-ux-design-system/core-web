import{_ as o,a}from"./tab-list-BNZszCrd.js";import"./iframe-FBZkkQm8.js";import"./preload-helper-0p_t5Nm2.js";import"./index-BwDkXOuE.js";import"./form-components-DhGhMahy.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,i={title:"Components/DBTabItem/Content Alignment Full Width",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},noText:{control:"boolean"},checked:{control:"boolean"},name:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},t={args:{label:"Left",default:""},render:e=>({components:{DBTabItem:a,DBTabList:o},setup(){return{args:e}},template:`<DBTabList  :style="{
  blockSize: '100%'
