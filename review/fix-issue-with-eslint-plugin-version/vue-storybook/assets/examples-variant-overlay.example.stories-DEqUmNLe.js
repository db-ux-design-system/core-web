import{_ as t}from"./link-MveyM2D1.js";import{_ as n}from"./notification-CTZiTXny.js";import"./iframe-CCALcMS5.js";import"./preload-helper-DGHI-tQh.js";import"./index-Bpz0UvTb.js";import"./constants-y2N5m1XS.js";import"./button-BBKcyKRJ.js";const{fn:y}=__STORYBOOK_MODULE_TEST__,b={title:"Components/DBNotification/Examples - Variant:Overlay",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},i={args:{variant:"overlay",default:"Text"},render:e=>({components:{DBNotification:n,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
