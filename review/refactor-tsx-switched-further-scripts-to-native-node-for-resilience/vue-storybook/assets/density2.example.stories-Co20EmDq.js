...
><DBCard
  ...
  >Functional</DBCard
>`},render:e=>({components:{DBSection:t,DBCard:r},setup(){return{args:e}},template:`<DBSection v-bind="args"   >${e.default}</DBSection>`})},s={args:{class:`db-color-informational db-bg-color-basic-level-2`,"data-density":`regular`,style:{display:`grid`,gap:`var(--db-spacing-fixed-sm)`,gridTemplateColumns:`repeat(2, minmax(0, 1fr))`},default:`<DBCard
  :style="{
  inlineSize: '100%'
}"
>
