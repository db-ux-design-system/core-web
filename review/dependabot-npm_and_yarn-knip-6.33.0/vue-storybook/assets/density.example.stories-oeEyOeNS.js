import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./brand-DMsq_-2O.js";import{n as r,t as i}from"./button-DFaPiItI.js";import{n as a,t as o}from"./navigation-item-CLdKbpye.js";import{n as s,t as c}from"./header-i_gB5wcI.js";import{n as l,t as u}from"./link-4B6tS7iL.js";import{n as d,t as f}from"./navigation-rnifp9qt.js";var p,m,h,g,_,v;function y(){return(y=e((()=>{t(),r(),u(),o(),f(),s(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/DBHeader/Density`,component:c,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},drawerOpen:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},h={args:{"data-density":`functional`,default:`<DBNavigation aria-label="Functional" v-bind="{}"
