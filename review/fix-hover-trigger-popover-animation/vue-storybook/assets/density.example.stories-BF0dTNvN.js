import{_ as i}from"./notification-CbbCmEXH.js";import"./iframe-BcVSOtgM.js";import"./preload-helper-C-04sqMD.js";import"./constants-CvUrIGJS.js";import"./index-Du5OQxST.js";import"./button-_L9X-j94.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,u={title:"Components/DBNotification/Density",component:i,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},e={args:{"data-density":"functional",headline:"Headline",icon:"information_circle",default:"functional"},render:n=>({components:{DBNotification:i},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
