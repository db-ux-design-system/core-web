...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:c,DBButton:t,DBInfotext:n,DBTableBody:s,DBTableDataCell:u,DBTableHead:o,DBTableHeaderCell:r,DBTableRow:i,DBTooltip:a},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
