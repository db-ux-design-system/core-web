...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:d,DBButton:t,DBCheckbox:r,DBInfotext:n,DBInput:u,DBLink:l,DBTableBody:c,DBTableDataCell:m,DBTableHead:s,DBTableHeaderCell:i,DBTableRow:a,DBTag:p,DBTooltip:o},setup(){return{args:e}},template:`<div  :style="{
  maxInlineSize: '100%',
  inlineSize: '1000px',
  display: 'flex',
