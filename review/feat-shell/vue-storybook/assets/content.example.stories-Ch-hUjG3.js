import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,F as n,G as r,Kt as i,N as a,Pt as o,Rt as s,St as c,Z as l,bt as u,ft as d,mt as f,t as p,vt as m}from"./src-Duq55lQ1.js";var h,g,_,v,y,b,x;e((()=>{p(),{fn:h}=__STORYBOOK_MODULE_TEST__,g={title:`Components/DBShell/Position`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},_={args:{"data-test-id":`shell-position-auto-top`,controlPanelDesktopPosition:`top`,default:`<DBControlPanelDesktop
...
><DBShellContent
  ...
  ><template v-slot:end-slot
    ><DBNotification headline="Test"> Test </DBNotification></template
  ></DBShellContent
>`},render:e=>({components:{DBShell:n,DBButton:i,DBControlPanelBrand:s,DBControlPanelDesktop:o,DBControlPanelMeta:t,DBControlPanelMobile:c,DBControlPanelNavigationItem:m,DBControlPanelNavigation:u,DBControlPanelPrimaryActions:f,DBControlPanelSecondaryActions:d,DBLink:l,DBNotification:r,DBShellContent:a},setup(){return{args:e}},template:`<div  :style="{
  width: '100%',
  display: 'block'
