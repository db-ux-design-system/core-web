import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{F as t,Kt as n,Mt as r,N as i,bt as a,j as o,t as s,vt as c}from"./src-Duq55lQ1.js";var l,u,d,f,p,m,h;e((()=>{s(),{fn:l}=__STORYBOOK_MODULE_TEST__,u={title:`Components/DBShell/Flat Icon`,component:t,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},d={args:{"data-test-id":`shell-flat-icon-with-text`,default:`<DBControlPanelFlatIcon
...
>`},render:e=>({components:{DBShell:t,DBButton:n,DBControlPanelFlatIcon:r,DBControlPanelNavigationItem:c,DBControlPanelNavigation:a,DBShellContent:i,DBShellSubNavigation:o},setup(){return{args:e}},template:`<div  :style="{
  width: '100%',
  display: 'block'
