import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{Et as t,Kt as n,t as r,wt as i}from"./src-Duq55lQ1.js";var a,o,s,c,l;e((()=>{r(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBDrawer/Show Spacing`,component:i,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:a()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},s={args:{containerSize:`full`,open:!1,showSpacing:!0,onClose:a(),default:`(Default) With Spacing<template v-slot:header
  ><DBDrawerHeader>(Default) With Spacing</DBDrawerHeader></template
>`},render:e=>({components:{DBDrawer:i,DBButton:n,DBDrawerHeader:t},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},c={args:{containerSize:`full`,showSpacing:!1,open:!1,onClose:a(),default:`Without Spacing<template v-slot:header
