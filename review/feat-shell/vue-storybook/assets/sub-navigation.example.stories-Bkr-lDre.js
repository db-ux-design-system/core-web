import{i as e}from"./preload-helper-sgvh3Ght.js";import{Bt as t,F as n,Mt as r,N as i,Ot as a,ct as o,ft as s,gt as c,j as l,mt as u,ot as d,q as f,t as p,ut as m,wt as h}from"./src-bYaG8MsC.js";var g,_,v,y,b,x,S;e((()=>{p(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={title:`Components/DBShell/Sub Navigation`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},v={args:{"data-test-id":`shell-top-sub-top`,controlPanelDesktopPosition:`top`,subNavigationDesktopPosition:`top`,showSubNavigation:!0,default:`<DBControlPanelDesktop
...
>`},render:e=>({components:{DBShell:n,DBButton:t,DBControlPanelBrand:r,DBControlPanelDesktop:a,DBControlPanelMeta:h,DBControlPanelMobile:c,DBControlPanelNavigationItemGroup:m,DBControlPanelNavigationItem:s,DBControlPanelNavigation:u,DBControlPanelPrimaryActions:o,DBControlPanelSecondaryActions:d,DBLink:f,DBShellContent:i,DBShellSubNavigation:l},setup(){return{args:e}},template:`<div  :style="{
  width: '100%',
  display: 'block'
