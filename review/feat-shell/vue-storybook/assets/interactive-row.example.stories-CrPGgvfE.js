...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:c,DBButton:n,DBInfotext:t,DBTableBody:s,DBTableDataCell:u,DBTableHead:o,DBTableHeaderCell:i,DBTableRow:a,DBTooltip:r},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
