...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:d,DBButton:r,DBCheckbox:t,DBInfotext:n,DBInput:l,DBLink:a,DBTableBody:u,DBTableDataCell:m,DBTableHead:c,DBTableHeaderCell:o,DBTableRow:s,DBTag:f,DBTooltip:i},setup(){return{args:e}},template:`<div  :style="{
  maxInlineSize: '100%',
  inlineSize: '1000px',
  display: 'flex',
