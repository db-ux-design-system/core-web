import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{Jt as t,Kt as n,Y as r,Z as i,et as a,q as o,t as s}from"./src-Duq55lQ1.js";var c,l,u,d,f;e((()=>{s(),{fn:c}=__STORYBOOK_MODULE_TEST__,l={title:`Components/DBHeader/Behavior`,component:a,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},drawerOpen:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},u={args:{default:`<DBNavigation aria-label="Desktop (full width)" v-bind="{}"
