import{i as e}from"./preload-helper-sgvh3Ght.js";import{t,tt as n}from"./src-bYaG8MsC.js";var r,i,a,o,s,c,l,u;e((()=>{t(),{fn:r}=__STORYBOOK_MODULE_TEST__,i={title:`Components/DBTag/Example Strong`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],args:{onRemove:r()},argTypes:{emphasis:{control:`select`,options:[`weak`,`strong`]},semantic:{control:`select`,options:[`adaptive`,`neutral`,`critical`,`informational`,`warning`,`successful`]},behavior:{control:`select`,options:[`static`,`removable`]},showIcon:{control:`boolean`},noText:{control:`boolean`},content:{control:`text`},showCheckState:{control:`boolean`},overflow:{control:`boolean`},removeButton:{control:`text`},text:{control:`text`},value:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`},onRemove:{action:`onRemove`}}},a={args:{emphasis:`strong`,icon:`x_placeholder`,behavior:`removable`,default:`<button>Interactive Strong Button with Icon</button>`},render:e=>({components:{DBTag:n},setup(){return{args:e}},template:`<DBTag v-bind="args"   >${e.default}</DBTag>`})},o={args:{emphasis:`strong`,icon:`x_placeholder`,default:`<a href="#">Interactive Strong Link with Icon</a>`},render:e=>({components:{DBTag:n},setup(){return{args:e}},template:`<DBTag v-bind="args"   >${e.default}</DBTag>`})},s={args:{emphasis:`strong`,icon:`x_placeholder`,default:`<label
  ><input type="checkbox" />
  Interactive Strong Checkbox with Icon
</label>`},render:e=>({components:{DBTag:n},setup(){return{args:e}},template:`<DBTag v-bind="args"   >${e.default}</DBTag>`})},c={args:{emphasis:`strong`,icon:`x_placeholder`,default:`<label
  ><input type="radio" name="radio03" />
  Interactive Strong Radio 1 with Icon
</label>`},render:e=>({components:{DBTag:n},setup(){return{args:e}},template:`<DBTag v-bind="args"   >${e.default}</DBTag>`})},l={args:{emphasis:`strong`,icon:`x_placeholder`,default:`<label
  ><input type="radio" name="radio03" />
