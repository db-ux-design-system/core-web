...
><DBTableBody
  ><DBTableRow
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:s,DBButton:n,DBInfotext:t,DBTableBody:o,DBTableDataCell:l,DBTableHead:a,DBTableHeaderCell:r,DBTableRow:i},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
