import{i as e}from"./preload-helper-BwUfbr8U.js";import{t}from"./jsx-runtime-BdAEV34Z.js";import{I as n,t as r}from"./src-DecBDu97.js";var i,a,o,s,c,l,u;e((()=>{r(),i=t(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBDrawer/Density`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:a()},argTypes:{open:{control:`boolean`},width:{control:`select`,options:[`full`,`auto`]},rounded:{control:`boolean`},spacing:{control:`select`,options:[`medium`,`small`,`large`,`none`]},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`left`,`right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},s={args:{open:!1,onClose:a(),children:`Functional`},render:e=>(0,i.jsxs)(`div`,{"data-density":`functional`,children:[`Open DBDrawer by switching open property`,(0,i.jsx)(n,{...e})]})},c={args:{open:!1,onClose:a(),children:`(Default) Regular`},render:e=>(0,i.jsxs)(`div`,{"data-density":`regular`,children:[`Open DBDrawer by switching open property`,(0,i.jsx)(n,{...e})]})},l={args:{open:!1,onClose:a(),children:`Expressive`},render:e=>(0,i.jsxs)(`div`,{"data-density":`expressive`,children:[`Open DBDrawer by switching open property`,(0,i.jsx)(n,{...e})]})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "open": false,
    "onClose": fn(),
    "children": "Functional"
