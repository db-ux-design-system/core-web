import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./badge-B_SnO6jx.js";import{n as r,t as i}from"./drawer-header-CHhVq9-u.js";import{n as a,t as o}from"./icon-DciCvIrJ.js";var s,c,l,u,d;function f(){return(f=e((()=>{t(),a(),r(),{fn:s}=__STORYBOOK_MODULE_TEST__,c={title:`Components/DBDrawerHeader/Slots`,component:i,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{text:{control:`text`},closeButtonText:{control:`text`},closeButtonId:{control:`text`},id:{control:`text`}}},l={args:{default:`With end slot<template v-slot:end-slot><DBBadge>New</DBBadge></template>`},render:e=>({components:{DBDrawerHeader:i,DBBadge:n,DBIcon:o},setup(){return{args:e}},template:`<div    ><DBDrawerHeader v-bind="args"   >${e.default}</DBDrawerHeader></div>`})},u={args:{default:`With start slot<template v-slot:start-slot
