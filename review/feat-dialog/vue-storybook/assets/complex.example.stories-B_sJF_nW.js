...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:x,DBButton:n,DBCheckbox:o,DBInfotext:i,DBInput:l,DBLink:p,DBTableBody:h,DBTableDataCell:b,DBTableHead:v,DBTableHeaderCell:_,DBTableRow:E,DBTag:d,DBTooltip:s},setup(){return{args:e}},template:`<div  :style="{
  maxInlineSize: '100%',
  inlineSize: '1000px',
  display: 'flex',
...
>`},render:e=>({components:{DBTable:x,DBButton:n,DBCheckbox:o,DBInfotext:i,DBInput:l,DBLink:p,DBTableBody:h,DBTableDataCell:b,DBTableHead:v,DBTableHeaderCell:_,DBTableRow:E,DBTag:d,DBTooltip:s},setup(){return{args:e}},template:`<div  :style="{
  ...
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    Mobile variant: List
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},N=[`Flat`,`Zebra`,`Spaced`,`MobilevariantList`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...M.parameters?.docs?.source}}}})))()}P();export{k as Flat,M as MobilevariantList,j as Spaced,A as Zebra,N as __namedExportsOrder,O as default};