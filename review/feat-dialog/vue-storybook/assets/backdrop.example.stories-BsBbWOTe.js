...
><template v-slot:header
  ...
  ></template
>`},render:e=>({components:{DBDialog:a,DBButton:n,DBDialogHeader:o},setup(){return{args:e}},template:`<div    ><DBButton  :onClick="(event) => openIndex = 2"  >
                    Open: No Backdrop
...
>\`
  ...
  render: (args: any) => ({
    ...
    template: \`<div    ><DBButton  :onClick="(event) => openIndex = 2"  >
                    Open: No Backdrop
                </DBButton><DBDialog v-bind="args"   >\${args.default}</DBDialog></div>\`
  })
