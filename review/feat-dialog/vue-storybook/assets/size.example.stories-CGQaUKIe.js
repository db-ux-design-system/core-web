import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./button-n_75JbZE.js";import{n as r,t as i}from"./infotext-BRX77aIs.js";import{n as a,t as o}from"./drawer-header-Bkv5dLPR.js";import{n as s,t as c}from"./drawer-DAgic4Gu.js";var l,u,d,f,p,m,h,g,_,v,y;function b(){return(b=e((()=>{t(),a(),r(),s(),{fn:l}=__STORYBOOK_MODULE_TEST__,u={title:`Components/DBDrawer/Container Size`,component:c,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:l(),onCancel:l()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`},onCancel:{action:`onCancel`}}},d={args:{id:`drawer-size-small`,containerSize:`small`,direction:`to-left`,open:!1,onClose:l(),default:`(Default) Small<template v-slot:header
