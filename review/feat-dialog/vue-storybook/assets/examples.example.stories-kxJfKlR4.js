import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./badge-VqQLON4Q.js";import{n as r,t as i}from"./button-n_75JbZE.js";import{n as a,t as o}from"./drawer-footer-CIYIW9Cv.js";import{n as s,t as c}from"./drawer-header-Bkv5dLPR.js";import{n as l,t as u}from"./drawer-DAgic4Gu.js";import{n as d,t as f}from"./link-BMlRtAx7.js";var p,m,h,g,_,v,y;function b(){return(b=e((()=>{t(),r(),a(),s(),f(),l(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/DBDrawer/Examples`,component:u,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:p(),onCancel:p()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`},onCancel:{action:`onCancel`}}},h={args:{id:`drawer-example-modal`,variant:`modal`,open:!1,onClose:p(),default:`(Default) As modal<template v-slot:header
