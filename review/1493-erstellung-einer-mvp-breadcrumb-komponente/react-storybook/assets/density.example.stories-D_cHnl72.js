import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as n}from"./navigation-item-D3hSWiZS.js";import"./index-B7He6KvY.js";import"./iframe-BrALMU0h.js";import"./preload-helper-B33QiPj0.js";import"./constants-C-ysBZRi.js";import"./floating-components-DAXMbqch.js";import"./button-CZgzC1pj.js";const{fn:s}=__STORYBOOK_MODULE_TEST__,g={title:"Components/DBNavigationItem/Density",component:n,parameters:{layout:"centered"},tags:["autodocs"],args:{onClick:s()},argTypes:{disabled:{control:"boolean"},active:{control:"boolean"},showIcon:{control:"boolean"},width:{control:"select",options:["full","auto"]},wrap:{control:"boolean"},text:{control:"text"},subNavigationExpanded:{control:"boolean"},backButtonId:{control:"text"},backButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},t={args:{"data-density":"functional",children:e.jsx("a",{href:"#",children:"Functional"})},render:r=>e.jsx("ul",{children:e.jsx(n,{...r})})},a={args:{"data-density":"regular",children:e.jsx("a",{href:"#",children:"(Default) Regular"})},render:r=>e.jsx("ul",{children:e.jsx(n,{...r})})},o={args:{"data-density":"expressive",children:e.jsx("a",{href:"#",children:"Expressive"})},render:r=>e.jsx("ul",{children:e.jsx(n,{...r})})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
