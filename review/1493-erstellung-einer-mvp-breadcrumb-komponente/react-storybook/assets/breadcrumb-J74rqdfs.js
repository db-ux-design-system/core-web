import{j as n}from"./jsx-runtime-u17CrQMm.js";import{a as w,c as k,g as x,f as T,p as L}from"./index-B7He6KvY.js";import{r as i}from"./iframe-s2U8Z2TN.js";import{D as l}from"./breadcrumb-item-BzG-tgua.js";function z(a,d){a={size:"small",separator:"chevron",ariaLabel:"Breadcrumb",ellipsisAriaLabel:"Expand to show all breadcrumb items",...a};const f=i.useId(),b=d||i.useRef(d),[h,p]=i.useState(()=>{});function c(){return a.id?`${a.id}-list`:h??""}const[s,g]=i.useState(()=>!1);function y(){g(!s)}function t(){return L(a.items)}function v(){const e=t(),r=a.maxItems??0;return e.length>0&&r>0&&e.length>r&&!s}function m(){const e=t(),r=a.maxItems??0,u=r>0?r-1:0;return u>0?e.slice(e.length-u):[]}function o(e,r){return e.ariaCurrent?e.ariaCurrent:r?"page":void 0}return i.useEffect(()=>{p(`db-breadcrumb-list-${f}`)},[]),n.jsx("nav",{ref:b,...T(a,["data-icon-variant","data-icon-variant-before","data-icon-variant-after","data-icon-weight","data-icon-weight-before","data-icon-weight-after","data-interactive","data-force-mobile","data-color","data-container-color","data-bg-color","data-on-bg-color","data-color-scheme","data-font-size","data-headline-size","data-divider","data-focus","data-font","data-density"]),id:a.id,"aria-label":a.ariaLabel,...x(a,["data-icon-variant","data-icon-variant-before","data-icon-variant-after","data-icon-weight","data-icon-weight-before","data-icon-weight-after","data-interactive","data-force-mobile","data-color","data-container-color","data-bg-color","data-on-bg-color","data-color-scheme","data-font-size","data-headline-size","data-divider","data-focus","data-font","data-density"]),className:k("db-breadcrumb",a.className),"data-size":a.size,"data-separator":a.separator,children:n.jsx("ol",{className:"db-breadcrumb-list",id:c(),children:t().length>0?n.jsx(n.Fragment,{children:v()?n.jsxs(n.Fragment,{children:[t()[0]?n.jsx(l,{className:t()[0].className,size:a.size,href:t()[0].href,ariaCurrent:o(t()[0],t().length===1),icon:t()[0].icon,text:t()[0].text},0):null,n.jsx("li",{className:"db-breadcrumb-item",children:n.jsx("button",{type:"button",className:"db-breadcrumb-ellipsis","aria-label":a.ellipsisAriaLabel??"Expand to show all breadcrumb items",title:a.ellipsisAriaLabel??"Expand to show all breadcrumb items","aria-expanded":w(s),"aria-controls":c(),onClick:e=>y(),children:"…"})},"ellipsis"),m()?.map((e,r)=>n.jsx(l,{className:e.className,size:a.size,href:e.href,ariaCurrent:o(e,r===m().length-1),icon:e.icon,text:e.text},r))]}):n.jsx(n.Fragment,{children:t()?.map((e,r)=>n.jsx(l,{className:e.className,size:a.size,href:e.href,ariaCurrent:o(e,r===t().length-1),icon:e.icon,text:e.text},r))})}):n.jsx(n.Fragment,{children:a.children})})})}const I=i.forwardRef(z);I.__docgenInfo={description:"",methods:[],displayName:"DBBreadcrumb",props:{size:{required:!1,tsType:{name:"unknown[number]",raw:"(typeof BreadcrumbSizeList)[number]"},description:"The size of the breadcrumb items.\n\nOptions: `small`, `medium`.\nDefault: `small`."},separator:{required:!1,tsType:{name:"unknown[number]",raw:"(typeof BreadcrumbSeparatorList)[number]"},description:"The separator shown between breadcrumb items.\n\nOptions: `chevron`, `slash`.\nDefault: `chevron`."},maxItems:{required:!1,tsType:{name:"number"},description:`Maximum number of items to display before collapsing.
