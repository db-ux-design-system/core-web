...
>`},render:e=>({components:{DBPopover:r,DBButton:n},setup(){return{args:e}},template:`<DBPopover v-bind="args"   >${e.default}</DBPopover>`})},l=[`DefaultAuto`,`Fixed`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "id": "popover-17",
...
}`,...c.parameters?.docs?.source}}}})))()}u();export{s as DefaultAuto,c as Fixed,l as __namedExportsOrder,o as default};