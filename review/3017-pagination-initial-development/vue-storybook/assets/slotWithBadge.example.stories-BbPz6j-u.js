...
><DBTabPanel>Settings content</DBTabPanel>`},render:e=>({components:{DBTabs:u,DBBadge:n,DBInfotext:i,DBTabItem:a,DBTabList:o,DBTabPanel:l},setup(){return{args:e}},template:`<div class="fit-content-container"   ><DBInfotext icon="none" size="small" semantic="informational"   >
                    Vertical:
                </DBInfotext><DBTabs v-bind="args"   >${e.default}</DBTabs></div>`})},_=[`Horizontal`,`Vertical`],h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    "default": \`<DBTabList
  ><DBTabItem>
    Messages
...
}`,...g.parameters?.docs?.source}}}})))()}v();export{h as Horizontal,g as Vertical,_ as __namedExportsOrder,m as default};