import{_ as r}from"./button-bXkbLoeD.js";import{_ as e}from"./tooltip-Dwo1-jLr.js";import"./iframe-C5y8L_AR.js";import"./preload-helper-Bo55khbC.js";import"./index-B2WiKbs4.js";import"./constants-y2N5m1XS.js";import"./document-scroll-listener-C1Gj1okB.js";import"./floating-components-CKmcRn_b.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,B={title:"Components/DBTooltip/Show Arrow",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{id:{control:"text"},showArrow:{control:"boolean"},emphasis:{control:"select",options:["weak","strong"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end","left","right","left-start","left-end","right-start","right-end"]},width:{control:"select",options:["auto","fixed"]},animation:{control:"boolean"},delay:{control:"select",options:["none","slow","fast"]},variant:{control:"select",options:["description","label"]},autofocus:{control:"boolean"}}},o={args:{id:"tooltip-04",showArrow:!0,default:"Tooltip"},render:t=>({components:{DBTooltip:e,DBButton:r},setup(){return{args:t}},template:`<DBButton    >
                (Default) True
