import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./button-CJErxTeS.js";import{n as r,t as i}from"./control-panel-flat-icon-zRLaNYQK.js";import{i as a,n as o,r as s,t as c}from"./control-panel-navigation-item-4bFkHrGp.js";import{i as l,n as u,r as d,t as f}from"./shell-content-umANH-T9.js";import{n as p,t as m}from"./shell-sub-navigation-C1JD2hoE.js";var h,g,_,v,y,b,x;function S(){return(S=e((()=>{t(),r(),o(),a(),f(),m(),d(),{fn:h}=__STORYBOOK_MODULE_TEST__,g={title:`Components/DBShell/Flat Icon`,component:l,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},_={args:{"data-test-id":`shell-flat-icon-with-text`,default:`<DBControlPanelFlatIcon
