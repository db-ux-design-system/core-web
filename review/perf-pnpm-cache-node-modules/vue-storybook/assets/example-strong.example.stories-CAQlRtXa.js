...
</label>`},render:e=>({components:{DBTag:t},setup(){return{args:e}},template:`<DBTag v-bind="args"   >${e.default}</DBTag>`})},u=[`InteractiveStrongButtonwithIcon`,`InteractiveStrongLinkwithIcon`,`InteractiveStrongCheckboxwithIcon`,`InteractiveStrongRadio1withIcon`,`InteractiveStrongRadio2withIcon`],a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    "emphasis": "strong",
    "icon": "x_placeholder",
    "behavior": "removable",
...
}`,...l.parameters?.docs?.source}}}})))()}d();export{a as InteractiveStrongButtonwithIcon,s as InteractiveStrongCheckboxwithIcon,o as InteractiveStrongLinkwithIcon,c as InteractiveStrongRadio1withIcon,l as InteractiveStrongRadio2withIcon,u as __namedExportsOrder,i as default};