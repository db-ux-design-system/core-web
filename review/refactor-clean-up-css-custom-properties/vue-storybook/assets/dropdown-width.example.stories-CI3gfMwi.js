import{_ as o}from"./infotext-9IvTmoq_.js";import{_ as t}from"./custom-select-CqR7j-KG.js";import"./iframe-CdW4nXyf.js";import"./preload-helper-B08UjP0c.js";import"./index-BSAZCWsy.js";import"./constants-y2N5m1XS.js";import"./document-scroll-listener-Dwig32RB.js";import"./floating-components-CKmcRn_b.js";import"./form-components-DN3LrxiF.js";import"./button-CqOGGZzl.js";import"./input-Bd4dGHXI.js";import"./tag-4aq2DMj_.js";import"./tooltip-DjD4__BT.js";const{fn:B}=__STORYBOOK_MODULE_TEST__,S={title:"Components/DBCustomSelect/Dropdown Width",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{options:{control:"object"},label:{control:"text"},placeholder:{control:"text"},id:{control:"text"},multiple:{control:"boolean"},variant:{control:"select",options:["above","floating"]},values:{control:"object"},showLabel:{control:"boolean"},message:{control:"text"},showMessage:{control:"boolean"},showIcon:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},invalidMessage:{control:"text"},validMessage:{control:"text"},required:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},disabled:{control:"boolean"},name:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},formFieldWidth:{control:"select",options:["full","auto"]},dropdownWidth:{control:"select",options:["auto","fixed"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end"]},selectedType:{control:"select",options:["amount","text","tag"]},showNoResults:{control:"boolean"},noResultsText:{control:"text"},showLoading:{control:"boolean"},loadingText:{control:"text"},showSearch:{control:"boolean"},showSelectAll:{control:"boolean"},showClearSelection:{control:"boolean"},removeTagsTexts:{control:"object"},searchValue:{control:"text"},searchLabel:{control:"text"},searchPlaceholder:{control:"text"},selectedLabels:{control:"text"},selectedPrefix:{control:"text"},selectAllLabel:{control:"text"},listLabel:{control:"text"},clearSelectionText:{control:"text"},amountText:{control:"text"},mobileCloseButtonText:{control:"text"},open:{control:"boolean"},autofocus:{control:"boolean"}}},l={args:{label:"(Default) Fixed",formFieldWidth:"full",dropdownWidth:"fixed",listLabel:"id-10227-(Default) Fixed",options:[{value:"Option 1",id:"99pgkheyw"},{value:"Option 2",id:"qc908rx6z"},{value:"Option 3",id:"qc908rx5z"},{value:"Option 4",id:"qc908rx4z"},{value:"Option 5",id:"qc908rx3z"}],default:""},render:e=>({components:{DBCustomSelect:t,DBInfotext:o},setup(){return{args:e}},template:`<div  :style="{
  width: '400px'
