...
><template v-slot:trigger><DBButton>Textarea</DBButton></template>`},render:e=>({components:{DBPopover:s,DBButton:n,DBCheckbox:i,DBInput:a,DBSwitch:l,DBTextarea:d},setup(){return{args:e}},template:`<DBPopover v-bind="args"   >${e.default}</DBPopover>`})},x=[`Switch`,`SwitchVisualAid`,`SwitchVisualAidClosed`,`Input`,`Checkbox`,`Textarea`],h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...b.parameters?.docs?.source}}}})))()}S();export{y as Checkbox,v as Input,h as Switch,g as SwitchVisualAid,_ as SwitchVisualAidClosed,b as Textarea,x as __namedExportsOrder,m as default};