import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./infotext-tz1b31zE.js";import{i as r,n as i,r as a,t as o}from"./tab-list-CxmksV_t.js";import{i as s,n as c,r as l,t as u}from"./tabs-CRPR9Gk4.js";var d,f,p,m,h,g,_;function v(){return(v=e((()=>{t(),a(),o(),l(),u(),{fn:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components/DBTabs/Overflow`,component:c,parameters:{layout:`centered`},tags:[`autodocs`],args:{onIndexChange:d(),onTabSelect:d()},argTypes:{orientation:{control:`select`,options:[`horizontal`,`vertical`]},tabItemWidth:{control:`select`,options:[`full`,`auto`]},tabItemAlignment:{control:`select`,options:[`start`,`center`,`end`]},behavior:{control:`select`,options:[`scrollbar`,`arrows`]},initialSelectedIndex:{control:`number`},initialSelectedMode:{control:`select`,options:[`auto`,`manually`]},label:{control:`text`},tabs:{control:`object`},arrowScrollDistance:{control:`number`},id:{control:`text`},autofocus:{control:`boolean`},onIndexChange:{action:`onIndexChange`},onTabSelect:{action:`onTabSelect`}}},p={args:{tabItemWidth:`auto`,default:`<DBTabList
...
><DBTabPanel>Dresden</DBTabPanel><DBTabPanel>Bremen</DBTabPanel>`},render:e=>({components:{DBTabs:c,DBInfotext:n,DBTabItem:r,DBTabList:i,DBTabPanel:s},setup(){return{args:e}},template:`<div class="fit-content-container" :style="{
  width: '300px'
                ...
                </DBInfotext><DBTabs v-bind="args"   >${e.default}</DBTabs></div>`})},_=[`nooverflow`,`withoverflowbehaviorarrows`,`withoverflowbehaviorscrollbar`,`arrowsheavyload12tabscustomdistance`],p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    "tabItemWidth": "auto",
    "default": \`<DBTabList
  ><DBTabItem>Test 1</DBTabItem><DBTabItem>Test 2</DBTabItem
...
}`,...g.parameters?.docs?.source}}}})))()}v();export{_ as __namedExportsOrder,g as arrowsheavyload12tabscustomdistance,f as default,p as nooverflow,m as withoverflowbehaviorarrows,h as withoverflowbehaviorscrollbar};