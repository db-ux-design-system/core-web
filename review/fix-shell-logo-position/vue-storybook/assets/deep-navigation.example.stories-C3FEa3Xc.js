import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./button-DS-z_-TV.js";import{i as r,n as i,r as a,t as o}from"./control-panel-actions-2-wO5wb9Jk.js";import{n as s,t as c}from"./control-panel-brand-DD-d0vBo.js";import{n as l,t as u}from"./control-panel-desktop-CKUx8otI.js";import{n as d,t as f}from"./control-panel-meta-Bw4Kbjle.js";import{n as p,t as m}from"./control-panel-mobile-CeEz2h0S.js";import{i as h,n as g,r as _,t as v}from"./control-panel-navigation-item-Do89BF8U.js";import{n as y,t as b}from"./control-panel-navigation-item-group-CUFHPCoC.js";import{n as x,t as S}from"./link-BRk60-UU.js";import{i as C,n as w,r as T,t as E}from"./shell-content-BxXtf4T6.js";var D,O,k,A,j;function M(){return(M=e((()=>{t(),r(),i(),s(),l(),d(),p(),y(),g(),h(),S(),E(),T(),{fn:D}=__STORYBOOK_MODULE_TEST__,O={title:`Components/DBShell/Deep Navigation`,component:C,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},k={args:{"data-test-id":`shell-deep-nav-top`,controlPanelDesktopPosition:`top`,default:`<DBControlPanelDesktop
...
>`},render:e=>({components:{DBShell:C,DBButton:n,DBControlPanelActions1:a,DBControlPanelActions2:o,DBControlPanelBrand:c,DBControlPanelDesktop:u,DBControlPanelMeta:f,DBControlPanelMobile:m,DBControlPanelNavigationItemGroup:b,DBControlPanelNavigationItem:v,DBControlPanelNavigation:_,DBLink:x,DBShellContent:w},setup(){return{args:e}},template:`<div  :style="{
  width: '100%',
  display: 'block'
}"  ><DBShell v-bind="args"   >${e.default}</DBShell></div>`})},j=[`Top`,`Left`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...A.parameters?.docs?.source}}}})))()}M();export{A as Left,k as Top,j as __namedExportsOrder,O as default};