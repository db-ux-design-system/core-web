import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,n,r,t as i}from"./footer-meta-BUwMHD4L.js";import{n as a,t as o}from"./link-BKUI8FVD.js";var s,c,l,u,d;function f(){return(f=e((()=>{n(),o(),t(),{fn:s}=__STORYBOOK_MODULE_TEST__,c={title:`Components/DBFooter/Copyright`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`large`,`medium`,`small`]},id:{control:`text`}}},l={args:{default:`<DBFooterMeta copyright="Example Company"
...
>`},render:e=>({components:{DBFooter:r,DBFooterMeta:i,DBLink:a},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},u={args:{default:`<DBFooterMeta
  ><nav aria-label="Legal navigation without copyright"
    ...
    ></nav
  ></DBFooterMeta
>`},render:e=>({components:{DBFooter:r,DBFooterMeta:i,DBLink:a},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},d=[`Customcopyright`,`Withoutcopyright`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...u.parameters?.docs?.source}}}})))()}f();export{l as Customcopyright,u as Withoutcopyright,d as __namedExportsOrder,c as default};