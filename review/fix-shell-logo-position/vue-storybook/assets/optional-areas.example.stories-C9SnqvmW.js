import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,n,r,t as i}from"./footer-meta-Dcu19Pcf.js";import{n as a,t as o}from"./footer-content-DrlNVu-1.js";import{n as s,t as c}from"./link-BRk60-UU.js";var l,u,d,f,p;function m(){return(m=e((()=>{a(),n(),c(),t(),{fn:l}=__STORYBOOK_MODULE_TEST__,u={title:`Components/DBFooter/Optional Areas`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`large`,`medium`,`small`]},id:{control:`text`}}},d={args:{default:`<DBFooterContent
...
>`},render:e=>({components:{DBFooter:r,DBFooterContent:o,DBFooterMeta:i,DBLink:s},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},f={args:{default:`<DBFooterMeta
  ...
  ></DBFooterMeta
>`},render:e=>({components:{DBFooter:r,DBFooterContent:o,DBFooterMeta:i,DBLink:s},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},p=[`Contentonly`,`Metaonly`],d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...f.parameters?.docs?.source}}}})))()}m();export{d as Contentonly,f as Metaonly,p as __namedExportsOrder,u as default};