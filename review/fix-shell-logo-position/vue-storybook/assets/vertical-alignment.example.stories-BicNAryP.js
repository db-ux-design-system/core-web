...
>`},render:e=>({components:{DBTable:d,DBButton:n,DBInfotext:i,DBTableBody:a,DBTableDataCell:u,DBTableHead:c,DBTableHeaderCell:s,DBTableRow:g},setup(){return{args:e}},template:`<div  :style="{
  ...
  gap: 'var(--db-spacing-fixed-md)'
                    ...
                    End
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},S=[`Start`,`DefaultCenter`,`End`],y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    "captionPlain": "Start",
    "divider": "both",
    "default": \`<DBTableHead
...
}`,...x.parameters?.docs?.source}}}})))()}C();export{b as DefaultCenter,x as End,y as Start,S as __namedExportsOrder,v as default};