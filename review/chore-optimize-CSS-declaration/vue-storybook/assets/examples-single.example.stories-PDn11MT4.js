import{_ as t}from"./custom-select-CfMMoN-1.js";import"./iframe-CiU9iosp.js";import"./preload-helper-DlA76sh6.js";import"./constants-BMPlMwqI.js";import"./index-nMDAkmV1.js";import"./document-scroll-listener-DH0Q7UsH.js";import"./floating-components-1F_x7pmN.js";import"./form-components-DdeCHFFQ.js";import"./button-CtEC6bkR.js";import"./infotext-ex-wz7Ig.js";import"./input-9N8BN70X.js";import"./tag-FFP9Ikxl.js";import"./tooltip-ChJwNYvf.js";const{fn:S}=__STORYBOOK_MODULE_TEST__,w={title:"Components/DBCustomSelect/Examples Single",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{options:{control:"object"},label:{control:"text"},placeholder:{control:"text"},id:{control:"text"},multiple:{control:"boolean"},variant:{control:"select",options:["above","floating"]},values:{control:"object"},showLabel:{control:"boolean"},message:{control:"text"},showMessage:{control:"boolean"},showIcon:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},invalidMessage:{control:"text"},validMessage:{control:"text"},required:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},disabled:{control:"boolean"},name:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},formFieldWidth:{control:"select",options:["full","auto"]},dropdownWidth:{control:"select",options:["auto","fixed"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end"]},selectedType:{control:"select",options:["amount","text","tag"]},showNoResults:{control:"boolean"},noResultsText:{control:"text"},showLoading:{control:"boolean"},loadingText:{control:"text"},showSearch:{control:"boolean"},showSelectAll:{control:"boolean"},showClearSelection:{control:"boolean"},removeTagsTexts:{control:"object"},searchValue:{control:"text"},searchLabel:{control:"text"},searchPlaceholder:{control:"text"},selectedLabels:{control:"text"},selectedPrefix:{control:"text"},selectAllLabel:{control:"text"},listLabel:{control:"text"},clearSelectionText:{control:"text"},amountText:{control:"text"},mobileCloseButtonText:{control:"text"},open:{control:"boolean"},autofocus:{control:"boolean"}}},o={args:{placeholder:"Placeholder",label:"Icons",listLabel:"id-10260-Icons",options:[{value:"Option 1",icon:"x_placeholder",id:"fvdhawk3a"},{value:"Option 2",icon:"x_placeholder",id:"i0pey2syc"},{value:"Option 3",icon:"x_placeholder",id:"i0pey3syc"},{value:"Option 4",icon:"x_placeholder",id:"i0pey4syc"},{value:"Option 5",icon:"x_placeholder",id:"i0pey5syc"}],default:""},render:e=>({components:{DBCustomSelect:t},setup(){return{args:e}},template:`<div  :style="{
  width: '200px'
