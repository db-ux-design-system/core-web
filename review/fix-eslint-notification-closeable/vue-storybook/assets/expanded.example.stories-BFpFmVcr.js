import{_ as n}from"./navigation-item-CF3-9Zfz.js";import"./iframe-NYmoKt2r.js";import"./preload-helper-C4DMSqXk.js";import"./constants-CvUrIGJS.js";import"./index-B2WiKbs4.js";import"./floating-components-CKmcRn_b.js";import"./button-BHpiBDVx.js";const{fn:u}=__STORYBOOK_MODULE_TEST__,c={title:"Components/DBNavigationItem/Expanded",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{disabled:{control:"boolean"},active:{control:"boolean"},showIcon:{control:"boolean"},width:{control:"select",options:["full","auto"]},wrap:{control:"boolean"},text:{control:"text"},subNavigationExpanded:{control:"boolean"},backButtonId:{control:"text"},backButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},a={args:{default:'<a href="#">(Default) False</a>'},render:t=>({components:{DBNavigationItem:n},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},e={args:{default:`True<template v-slot:sub-navigation
  ><DBNavigationItem>
