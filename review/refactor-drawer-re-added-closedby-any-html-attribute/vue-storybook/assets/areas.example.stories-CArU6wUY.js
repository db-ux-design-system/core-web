import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./badge-CShydt7C.js";import{n as r,t as i}from"./button-SZ7Brqmw.js";import{n as a,t as o}from"./drawer-footer-C_Fddsln.js";import{n as s,t as c}from"./drawer-header-CI0A-6pn.js";import{n as l,t as u}from"./drawer-WNwm_SDC.js";import{n as d,t as f}from"./icon-CJe4HRC8.js";import{n as p,t as m}from"./link-1H5cJDO0.js";var h,g,_,v,y,b,x;function S(){return(S=e((()=>{t(),r(),a(),s(),d(),m(),l(),{fn:h}=__STORYBOOK_MODULE_TEST__,g={title:`Components/DBDrawer/Areas`,component:u,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:h(),onCancel:h()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`},onCancel:{action:`onCancel`}}},_={args:{open:!1,onClose:h(),default:`Lorem ipsum dolor sit amet.<template v-slot:header
  ><DBDrawerHeader
    text="With text prop"
...
><template v-slot:footer
  ...
  ></template
>`},render:e=>({components:{DBDrawer:u,DBBadge:n,DBButton:i,DBDrawerFooter:o,DBDrawerHeader:c,DBIcon:f,DBLink:p},setup(){return{args:e}},template:`<div    >Open DBDrawer by switching open property<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},x=[`Withtextprop`,`Withstartslot`,`Withendslot`,`Withfooter`],_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    "open": false,
    "onClose": fn(),
