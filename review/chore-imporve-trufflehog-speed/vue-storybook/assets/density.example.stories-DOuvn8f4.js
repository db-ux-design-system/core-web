import{i as e}from"./preload-helper-UOmusvBV.js";import{D as t,Q as n,k as r,t as i}from"./src-DsIUtERp.js";var a,o,s,c,l,u;e((()=>{i(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBNavigation/Density`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{id:{control:`text`},autofocus:{control:`boolean`}}},s={args:{"aria-labelledby":`functional`,default:`<DBNavigationItem>
  Navi-Item 1
...
>`},render:e=>({components:{DBNavigation:r,DBInfotext:n,DBNavigationItem:t},setup(){return{args:e}},template:`<div class="fit-content-container" data-density="functional"   ><DBInfotext id="functional" size="small" semantic="informational" icon="none"   >
                    Functional
...
><DBNavigationItem :disabled="true"
  ><a href="#">Navi-Item 3</a></DBNavigationItem
>`},render:e=>({components:{DBNavigation:r,DBInfotext:n,DBNavigationItem:t},setup(){return{args:e}},template:`<div class="fit-content-container" data-density="regular"   ><DBInfotext id="_default__regular" size="small" semantic="informational" icon="none"   >
                    (Default) Regular
...
><DBNavigationItem :disabled="true"
  ><a href="#">Navi-Item 3</a></DBNavigationItem
>`},render:e=>({components:{DBNavigation:r,DBInfotext:n,DBNavigationItem:t},setup(){return{args:e}},template:`<div class="fit-content-container" data-density="expressive"   ><DBInfotext id="expressive" size="small" semantic="informational" icon="none"   >
                    Expressive
