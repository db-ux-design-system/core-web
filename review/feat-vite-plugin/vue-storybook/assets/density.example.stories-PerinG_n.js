import{_ as i}from"./notification-CqsPst_K.js";import"./iframe-Ch1pSpUp.js";import"./preload-helper-BOm8tZL-.js";import"./constants-y2N5m1XS.js";import"./index-Deril_kb.js";import"./button-DqS7KG6s.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,u={title:"Components/DBNotification/Density",component:i,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},e={args:{"data-density":"functional",headline:"Headline",icon:"information_circle",default:"functional"},render:n=>({components:{DBNotification:i},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
