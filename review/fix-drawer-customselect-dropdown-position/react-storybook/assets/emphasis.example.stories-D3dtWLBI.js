import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as s}from"./divider-BkNgmvb7.js";import{D as a}from"./infotext-DfYE7gyK.js";import"./index-D2E5Z_bU.js";import"./iframe-BxtHEjTJ.js";import"./preload-helper-DH1N_sIH.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,f={title:"Components/DBDivider/Emphasis",component:s,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{width:{control:"select",options:["full","auto"]},variant:{control:"select",options:["horizontal","vertical"]},emphasis:{control:"select",options:["weak","strong"]},margin:{control:"select",options:["medium","small","large","none","_"]},id:{control:"text"},autofocus:{control:"boolean"}}},t={args:{width:"full"},render:o=>e.jsxs("div",{style:{width:"200px"},children:[e.jsx(a,{size:"small",semantic:"informational",children:"(Default) Weak"}),e.jsx(s,{...o})]})},r={args:{emphasis:"strong",width:"full"},render:o=>e.jsxs("div",{style:{width:"200px"},children:[e.jsx(a,{size:"small",semantic:"informational",children:"Strong"}),e.jsx(s,{...o})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    "width": "full"
  },
