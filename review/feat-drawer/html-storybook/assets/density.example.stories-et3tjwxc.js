import{i as e}from"./preload-helper-Dvc_-dbk.js";import{t}from"./iframe-Dw2QiuC7.js";import{X as n,et as r,t as i}from"./src-DRA-0rXi.js";var a,o,s,c,l,u,d;e((()=>{i(),a=t(),{fn:o}=__STORYBOOK_MODULE_TEST__,s={title:`Components/DBDrawer/Density`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:o()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`left`,`right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},c={args:{open:!1,onClose:o(),header:(0,a.jsx)(n,{children:`Functional`}),children:`Functional`},render:e=>(0,a.jsxs)(`div`,{"data-density":`functional`,children:[`Open DBDrawer by switching open property`,(0,a.jsx)(r,{...e})]})},l={args:{open:!1,onClose:o(),header:(0,a.jsx)(n,{children:`(Default) Regular`}),children:`(Default) Regular`},render:e=>(0,a.jsxs)(`div`,{"data-density":`regular`,children:[`Open DBDrawer by switching open property`,(0,a.jsx)(r,{...e})]})},u={args:{open:!1,onClose:o(),header:(0,a.jsx)(n,{children:`Expressive`}),children:`Expressive`},render:e=>(0,a.jsxs)(`div`,{"data-density":`expressive`,children:[`Open DBDrawer by switching open property`,(0,a.jsx)(r,{...e})]})},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    "open": false,
    "onClose": fn(),
