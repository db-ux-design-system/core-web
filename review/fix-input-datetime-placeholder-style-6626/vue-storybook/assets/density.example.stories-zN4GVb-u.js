import{i as e}from"./preload-helper-C3qED_x7.js";import{U as t,V as n,ft as r,t as i}from"./src-cs3jKAwA.js";var a,o,s,c,l,u;e((()=>{i(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBNavigation/Density`,component:t,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{id:{control:`text`},autofocus:{control:`boolean`}}},s={args:{"aria-labelledby":`functional`,default:`<DBNavigationItem>
  Navi-Item 1
...
>`},render:e=>({components:{DBNavigation:t,DBInfotext:r,DBNavigationItem:n},setup(){return{args:e}},template:`<div class="fit-content-container" data-density="functional"   ><DBInfotext id="functional" size="small" semantic="informational" icon="none"   >
                    Functional
...
><DBNavigationItem :disabled="true"
  ><a href="#">Navi-Item 3</a></DBNavigationItem
>`},render:e=>({components:{DBNavigation:t,DBInfotext:r,DBNavigationItem:n},setup(){return{args:e}},template:`<div class="fit-content-container" data-density="regular"   ><DBInfotext id="_default__regular" size="small" semantic="informational" icon="none"   >
                    (Default) Regular
...
><DBNavigationItem :disabled="true"
  ><a href="#">Navi-Item 3</a></DBNavigationItem
>`},render:e=>({components:{DBNavigation:t,DBInfotext:r,DBNavigationItem:n},setup(){return{args:e}},template:`<div class="fit-content-container" data-density="expressive"   ><DBInfotext id="expressive" size="small" semantic="informational" icon="none"   >
                    Expressive
