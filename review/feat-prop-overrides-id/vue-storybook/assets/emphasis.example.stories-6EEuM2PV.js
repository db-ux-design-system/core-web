import{_ as e}from"./tooltip-7lcJLJAK.js";import{_ as r}from"./button-Ju2rUeQy.js";import"./iframe-CPPSwYUo.js";import"./preload-helper-GRKlKgLe.js";import"./constants-CvUrIGJS.js";import"./index-BzYpqoXM.js";import"./document-scroll-listener-CLxTdHp9.js";import"./floating-components-jmncKSnU.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,B={title:"Components/DBTooltip/Emphasis",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{id:{control:"text"},showArrow:{control:"boolean"},emphasis:{control:"select",options:["weak","strong"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end","left","right","left-start","left-end","right-start","right-end"]},width:{control:"select",options:["auto","fixed"]},animation:{control:"boolean"},delay:{control:"select",options:["none","slow","fast"]},variant:{control:"select",options:["description","label"]},autofocus:{control:"boolean"}}},o={args:{id:"tooltip-06",default:"Tooltip"},render:t=>({components:{DBTooltip:e,DBButton:r},setup(){return{args:t}},template:`<DBButton    >
                (Default) Weak
