...
><DBAccordionItem headlinePlain="Item 3"> Content 3 </DBAccordionItem>`},render:e=>({components:{DBAccordion:i,DBAccordionItem:n,DBInfotext:o},setup(){return{args:e}},template:`<div    ><DBInfotext size="small" semantic="informational" icon="none"   >
                    Card
                </DBInfotext><DBAccordion v-bind="args"   >${e.default}</DBAccordion></div>`})},d=[`Divider`,`Card`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    "variant": "divider",
...
}`,...u.parameters?.docs?.source}}}})))()}f();export{u as Card,l as Divider,d as __namedExportsOrder,c as default};