import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./infotext--7-KF0fC.js";import{i as r,n as i,r as a,t as o}from"./pagination-DDe3lNam.js";var s,c,l,u;function d(){return(d=e((()=>{t(),a(),o(),{fn:s}=__STORYBOOK_MODULE_TEST__,c={title:`Components/DBPagination/Link`,component:i,parameters:{layout:`centered`},tags:[`autodocs`],args:{onPageChange:s()},argTypes:{currentPage:{control:`number`},totalCount:{control:`number`},pageSize:{control:`number`},siblingCount:{control:`number`},boundaryCount:{control:`number`},size:{control:`select`,options:[`small`,`medium`]},label:{control:`text`},previousLabel:{control:`text`},nextLabel:{control:`text`},pageLabel:{control:`text`},onPageChange:{action:`onPageChange`},id:{control:`text`}}},l={args:{label:`Linked pagination`,currentPage:2,onPageChange:s(),default:`<DBPaginationItem><a href="#linked-page=1">1</a></DBPaginationItem
