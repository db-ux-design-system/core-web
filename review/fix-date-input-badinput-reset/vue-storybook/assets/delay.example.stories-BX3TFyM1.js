...
>
<DBButton>Popover Custom Item 3</DBButton
><template v-slot:trigger><DBButton>Fast</DBButton></template>`},render:e=>({components:{DBPopover:r,DBButton:n},setup(){return{args:e}},template:`<DBPopover v-bind="args"   >${e.default}</DBPopover>`})},u=[`DefaultNone`,`Slow`,`Fast`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "id": "popover-133",
    "delay": "none",
...
}`,...l.parameters?.docs?.source}}}})))()}d();export{s as DefaultNone,l as Fast,c as Slow,u as __namedExportsOrder,o as default};