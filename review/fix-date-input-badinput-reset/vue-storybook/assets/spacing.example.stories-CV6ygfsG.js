...
>
<DBButton>Popover Custom Item 3</DBButton
><template v-slot:trigger><DBButton>None</DBButton></template>`},render:e=>({components:{DBPopover:r,DBButton:n},setup(){return{args:e}},template:`<DBPopover v-bind="args"   >${e.default}</DBPopover>`})},d=[`DefaultSmall`,`Medium`,`Large`,`None`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "spacing": "small",
    "id": "popover-04",
