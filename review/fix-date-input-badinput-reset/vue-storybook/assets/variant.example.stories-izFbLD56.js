...
><DBDivider></DBDivider><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:a,DBDivider:i,DBInfotext:n},setup(){return{args:e}},template:`<div  :style="{
  ...
  width: '200px'
                    ...
                    Divider
                </DBInfotext><DBStack v-bind="args"   >${e.default}</DBStack></div>`})},d=[`DefaultSimple`,`Divider`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    "style": {
...
}`,...u.parameters?.docs?.source}}}})))()}f();export{l as DefaultSimple,u as Divider,d as __namedExportsOrder,c as default};