import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./badge-BZIRPSZr.js";import{n as r,t as i}from"./button-CFaO40Uy.js";import{n as a,t as o}from"./drawer-footer-BFyD-626.js";import{n as s,t as c}from"./drawer-header-gu-gPmlb.js";import{n as l,t as u}from"./drawer-CJQ3yFkA.js";import{n as d,t as f}from"./icon-GYv-KBk_.js";import{n as p,t as m}from"./link-B5ts-asP.js";var h,g,_,v,y,b,x,S,C,w,T;function E(){return(E=e((()=>{t(),r(),a(),s(),d(),m(),l(),{fn:h}=__STORYBOOK_MODULE_TEST__,g={title:`Components/DBDrawer/Examples`,component:u,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:h(),onCancel:h()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`},onCancel:{action:`onCancel`}}},_={args:{variant:`modal`,propOverrides:{id:`drawer-example-modal`},default:`(Default) As modal<template v-slot:header
