...
><DBTableBody
  ...
  ><DBTableRow :interactive="true"
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:d,DBButton:r,DBCheckbox:l,DBInfotext:a,DBInput:i,DBLink:t,DBTableBody:u,DBTableDataCell:m,DBTableHead:s,DBTableHeaderCell:n,DBTableRow:o,DBTag:f,DBTooltip:c},setup(){return{args:e}},template:`<div  :style="{
  maxInlineSize: '100%',
  inlineSize: '1000px',
  display: 'flex',
