import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./brand-CVNAAbva.js";import{n as r,t as i}from"./button-D7dTj-rI.js";import{n as a,t as o}from"./header-dSgCAOfs.js";import{n as s,t as c}from"./link-CRVB1Oct.js";import{n as l,t as u}from"./navigation-CZXg3kko.js";import{n as d,t as f}from"./navigation-item-DIZQmdJk.js";var p,m,h,g,_,v;function y(){return(y=e((()=>{t(),r(),c(),f(),u(),a(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/DBHeader/Density`,component:o,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},drawerOpen:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},h={args:{"data-density":`functional`,default:`<DBNavigation aria-label="Functional" v-bind="{}"
