import{_ as t}from"./notification-soEdgS0g.js";import"./iframe-Dt7BtX4F.js";import"./preload-helper-Cogb-lJ0.js";import"./constants-BMPlMwqI.js";import"./index-nMDAkmV1.js";import"./button-JXuLrTlL.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,g={title:"Components/DBNotification/Semantic",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},delay:{control:"select",options:["none","slow","fast"]},animation:{control:"boolean"},width:{control:"select",options:["auto","fixed"]},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},e={args:{headline:"Headline",default:"(Default) Adaptive"},render:n=>({components:{DBNotification:t},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
