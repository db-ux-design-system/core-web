import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./button-YLr-bnbk.js";import{i as r,n as i,r as a,t as o}from"./control-panel-actions-2-BwfCs8Yr.js";import{n as s,t as c}from"./control-panel-brand-CL2CpbXn.js";import{n as l,t as u}from"./control-panel-desktop-DIoJgY_r.js";import{n as d,t as f}from"./control-panel-meta-CuJhdc7O.js";import{n as p,t as m}from"./control-panel-mobile-Dw9jRTiP.js";import{i as h,n as g,r as _,t as v}from"./control-panel-navigation-item-BHi25zLp.js";import{n as y,t as b}from"./control-panel-navigation-item-group-DwDco6zO.js";import{n as x,t as S}from"./link-Bs1RzF49.js";import{i as C,n as w,r as T,t as E}from"./shell-content-CmabhFbc.js";var D,O,k,A,j;function M(){return(M=e((()=>{t(),r(),i(),s(),l(),d(),p(),y(),g(),h(),S(),E(),T(),{fn:D}=__STORYBOOK_MODULE_TEST__,O={title:`Components/DBShell/Tree Navigation`,component:C,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{controlPanelDesktopPosition:{control:`select`,options:[`top`,`left`]},controlPanelMobilePosition:{control:`select`,options:[`top`,`bottom`]},subNavigationDesktopPosition:{control:`select`,options:[`top`,`left`]},subNavigationMobilePosition:{control:`select`,options:[`top`,`bottom`,`none`]},showSubNavigation:{control:`boolean`},fadeIn:{control:`boolean`},id:{control:`text`},autofocus:{control:`boolean`}}},k={args:{"data-test-id":`shell-tree-nav-single`,controlPanelDesktopPosition:`left`,default:`<DBControlPanelDesktop
...
>`},render:e=>({components:{DBShell:C,DBButton:n,DBControlPanelActions1:a,DBControlPanelActions2:o,DBControlPanelBrand:c,DBControlPanelDesktop:u,DBControlPanelMeta:f,DBControlPanelMobile:m,DBControlPanelNavigationItemGroup:b,DBControlPanelNavigationItem:v,DBControlPanelNavigation:_,DBLink:x,DBShellContent:w},setup(){return{args:e}},template:`<div  :style="{
  width: '100%',
  display: 'block'
}"  ><DBShell v-bind="args"   >${e.default}</DBShell></div>`})},j=[`Single`,`Multiple`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...A.parameters?.docs?.source}}}})))()}M();export{A as Multiple,k as Single,j as __namedExportsOrder,O as default};