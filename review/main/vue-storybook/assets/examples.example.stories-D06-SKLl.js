...
><DBTabPanel>Tab Panel 3</DBTabPanel>`},render:e=>({components:{DBTabs:c,DBInfotext:n,DBTabItem:r,DBTabList:i,DBTabPanel:s},setup(){return{args:e}},template:`<div class="fit-content-container"   ><DBInfotext icon="none" size="small" semantic="informational"   >
                    nothing selected:
                </DBInfotext><DBTabs v-bind="args"   >${e.default}</DBTabs></div>`})},h=[`SecondTestselected`,`nothingselected`],p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...m.parameters?.docs?.source}}}})))()}g();export{p as SecondTestselected,h as __namedExportsOrder,f as default,m as nothingselected};