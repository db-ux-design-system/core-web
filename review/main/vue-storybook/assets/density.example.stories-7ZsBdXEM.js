import{i as e}from"./preload-helper-CgwILqPo.js";import{D as t,b as n,t as r}from"./src-xQFCjMZy.js";var i,a,o,s,c,l;e((()=>{r(),{fn:i}=__STORYBOOK_MODULE_TEST__,a={title:`Components/DBDivider/Density`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`auto`]},variant:{control:`select`,options:[`horizontal`,`vertical`]},emphasis:{control:`select`,options:[`weak`,`strong`]},margin:{control:`select`,options:[`medium`,`small`,`large`,`none`,`_`]},id:{control:`text`},autofocus:{control:`boolean`}}},o={args:{width:`full`,default:``},render:e=>({components:{DBDivider:n,DBInfotext:t},setup(){return{args:e}},template:`<div data-density="functional" :style="{
  width: '200px'
