import{_ as n}from"./navigation-item-B1UX-CcX.js";import"./iframe-Dl80bcAY.js";import"./preload-helper-Cogb-lJ0.js";import"./constants-y2N5m1XS.js";import"./index-DPATXrhb.js";import"./floating-components-CKmcRn_b.js";import"./button-CnNBOgTF.js";const{fn:u}=__STORYBOOK_MODULE_TEST__,c={title:"Components/DBNavigationItem/Expanded",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{disabled:{control:"boolean"},active:{control:"boolean"},showIcon:{control:"boolean"},width:{control:"select",options:["full","auto"]},wrap:{control:"boolean"},text:{control:"text"},subNavigationExpanded:{control:"boolean"},backButtonId:{control:"text"},backButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},a={args:{default:'<a href="#">(Default) False</a>'},render:t=>({components:{DBNavigationItem:n},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},e={args:{default:`True<template v-slot:sub-navigation
  ><DBNavigationItem>
