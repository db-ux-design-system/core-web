...
/></template>`},render:e=>({components:{DBNotification:r,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
}"  ><DBNotification v-bind="args"   >${e.default}</DBNotification></div>`})},l={args:{headline:`Headline`,variant:`standalone`,default:`Text & Headline`},render:e=>({components:{DBNotification:r,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
