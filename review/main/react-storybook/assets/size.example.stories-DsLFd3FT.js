import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as o}from"./badge-gZInndTb.js";import"./index-D2E5Z_bU.js";import"./iframe-caz8HMyj.js";import"./preload-helper-CIh9CwYI.js";import"./constants-C-ysBZRi.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,d={title:"Components/DBBadge/Size",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{emphasis:{control:"select",options:["weak","strong"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},size:{control:"select",options:["small","medium"]},placement:{control:"select",options:["inline","corner-top-left","corner-top-right","corner-center-left","corner-center-right","corner-bottom-left","corner-bottom-right"]},label:{control:"text"},text:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{children:"(Default) Small"},render:t=>n.jsx(o,{...t})},r={args:{size:"medium",children:"Medium"},render:t=>n.jsx(o,{...t})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
