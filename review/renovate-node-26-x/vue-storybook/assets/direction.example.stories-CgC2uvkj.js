...
><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:r,DBInfotext:n},setup(){return{args:e}},template:`<div  :style="{
  ...
  height: '100px'
                    ...
                    Row
                </DBInfotext><DBStack v-bind="args"   >${e.default}</DBStack></div>`})},l=[`DefaultColumn`,`Row`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "style": {
...
}`,...c.parameters?.docs?.source}}}})))()}u();export{s as DefaultColumn,c as Row,l as __namedExportsOrder,o as default};