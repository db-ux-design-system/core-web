import{n as e}from"./chunk-DnJy8xQt.js";import{k as t,t as n,y as r}from"./src-9wi74StN.js";var i,a,o,s,c,l,u;e((()=>{n(),{fn:i}=__STORYBOOK_MODULE_TEST__,a={title:`Components/DBDrawer/Backdrop`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:i()},argTypes:{open:{control:`boolean`},width:{control:`select`,options:[`full`,`auto`]},rounded:{control:`boolean`},spacing:{control:`select`,options:[`medium`,`small`,`large`,`none`]},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`left`,`right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},o={args:{id:`drawer-backdrop-strong`,backdrop:`strong`,default:`(Default) Strong`},render:e=>({components:{DBDrawer:r,DBButton:t},setup(){return{args:e}},template:`<div    >Open DBDrawer via command and commandfor<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},s={args:{id:`drawer-backdrop-weak`,backdrop:`weak`,default:`Weak`},render:e=>({components:{DBDrawer:r,DBButton:t},setup(){return{args:e}},template:`<div    >Open DBDrawer via command and commandfor<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},c={args:{id:`drawer-backdrop-invisible`,backdrop:`invisible`,default:`Invisible`},render:e=>({components:{DBDrawer:r,DBButton:t},setup(){return{args:e}},template:`<div    >Open DBDrawer via command and commandfor<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},l={args:{id:`drawer-backdrop-none`,backdrop:`none`,default:`No Backdrop`},render:e=>({components:{DBDrawer:r,DBButton:t},setup(){return{args:e}},template:`<div    >Open DBDrawer via command and commandfor<DBDrawer v-bind="args"   >${e.default}</DBDrawer></div>`})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
