import{n as e}from"./chunk-DnJy8xQt.js";import{A as t,h as n,m as r,t as i,v as a}from"./src-CFH3E_Mb.js";var o,s,c,l,u,d,f;e((()=>{i(),{fn:o}=__STORYBOOK_MODULE_TEST__,s={title:`Components/DBHeader/Examples`,component:a,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},c={args:{default:`<DBNavigation aria-label="With Application Name + Navigation" v-bind="{}"
