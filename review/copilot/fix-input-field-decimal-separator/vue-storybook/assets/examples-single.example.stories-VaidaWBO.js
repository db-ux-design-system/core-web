import{_ as t}from"./custom-select-_90bYT04.js";import"./iframe-Tz73j_Qf.js";import"./preload-helper-s-P4lWUm.js";import"./constants-CvUrIGJS.js";import"./index-Cttz2oIF.js";import"./document-scroll-listener-CTBFIa93.js";import"./floating-components-jmncKSnU.js";import"./form-components-BPjLUHuG.js";import"./button-D6IGcAfX.js";import"./infotext-CeKghRdJ.js";import"./input-Iv26X4LX.js";import"./tag-Dg7qk3fd.js";import"./tooltip-SB06BFQA.js";const{fn:S}=__STORYBOOK_MODULE_TEST__,w={title:"Components/DBCustomSelect/Examples Single",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{options:{control:"object"},label:{control:"text"},placeholder:{control:"text"},id:{control:"text"},multiple:{control:"boolean"},variant:{control:"select",options:["above","floating"]},values:{control:"object"},showLabel:{control:"boolean"},message:{control:"text"},showMessage:{control:"boolean"},showIcon:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},invalidMessage:{control:"text"},validMessage:{control:"text"},required:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},disabled:{control:"boolean"},name:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},formFieldWidth:{control:"select",options:["full","auto"]},dropdownWidth:{control:"select",options:["auto","fixed"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end"]},selectedType:{control:"select",options:["amount","text","tag"]},showNoResults:{control:"boolean"},noResultsText:{control:"text"},showLoading:{control:"boolean"},loadingText:{control:"text"},showSearch:{control:"boolean"},showSelectAll:{control:"boolean"},showClearSelection:{control:"boolean"},removeTagsTexts:{control:"object"},searchValue:{control:"text"},searchLabel:{control:"text"},searchPlaceholder:{control:"text"},selectedLabels:{control:"text"},selectedPrefix:{control:"text"},selectAllLabel:{control:"text"},listLabel:{control:"text"},clearSelectionText:{control:"text"},amountText:{control:"text"},mobileCloseButtonText:{control:"text"},open:{control:"boolean"},autofocus:{control:"boolean"}}},o={args:{placeholder:"Placeholder",label:"Icons",listLabel:"id-10260-Icons",options:[{value:"Option 1",icon:"x_placeholder",id:"fvdhawk3a"},{value:"Option 2",icon:"x_placeholder",id:"i0pey2syc"},{value:"Option 3",icon:"x_placeholder",id:"i0pey3syc"},{value:"Option 4",icon:"x_placeholder",id:"i0pey4syc"},{value:"Option 5",icon:"x_placeholder",id:"i0pey5syc"}],default:""},render:e=>({components:{DBCustomSelect:t},setup(){return{args:e}},template:`<div  :style="{
  width: '200px'
