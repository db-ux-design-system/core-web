import{_ as o}from"./navigation-item-CEEI7WwC.js";import"./iframe-gwJ7bdfB.js";import"./preload-helper-BUQEUc4V.js";import"./constants-BMPlMwqI.js";import"./index-DPPzDY5H.js";import"./floating-components-1F_x7pmN.js";import"./button-B4loOJxs.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,p={title:"Components/DBNavigationItem/Density",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{disabled:{control:"boolean"},active:{control:"boolean"},showIcon:{control:"boolean"},width:{control:"select",options:["full","auto"]},wrap:{control:"boolean"},text:{control:"text"},subNavigationExpanded:{control:"boolean"},backButtonId:{control:"text"},backButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},e={args:{"data-density":"functional",default:'<a href="#">Functional</a>'},render:t=>({components:{DBNavigationItem:o},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},a={args:{"data-density":"regular",default:'<a href="#">(Default) Regular</a>'},render:t=>({components:{DBNavigationItem:o},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},n={args:{"data-density":"expressive",default:'<a href="#">Expressive</a>'},render:t=>({components:{DBNavigationItem:o},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
