import{j as r}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as t}from"./tab-list-BzM0IPYd.js";import"./index-D2E5Z_bU.js";import"./iframe-BbUAKveN.js";import"./preload-helper-DJRE9f5X.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,m={title:"Components/DBTabItem/Show Icon Leading",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},noText:{control:"boolean"},checked:{control:"boolean"},name:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{label:"(Default) False",icon:"x_placeholder",showIcon:!1},render:a=>r.jsx(t,{children:r.jsx(n,{...a})})},o={args:{label:"True",icon:"x_placeholder",showIcon:!0},render:a=>r.jsx(t,{children:r.jsx(n,{...a})})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    "label": "(Default) False",
    "icon": "x_placeholder",
    "showIcon": false
