...
>`},render:e=>({components:{DBNotification:r,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  ...
  width: '300px'
}"  ><DBNotification v-bind="args"   >${e.default}</DBNotification></div>`})},l=[`DefaultBlock`,`Inline`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "linkVariant": "block",
...
}`,...c.parameters?.docs?.source}}}})))()}u();export{s as DefaultBlock,c as Inline,l as __namedExportsOrder,o as default};