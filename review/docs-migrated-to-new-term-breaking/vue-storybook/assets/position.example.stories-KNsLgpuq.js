...
></template>`},render:e=>({components:{DBControlPanelMobile:i,DBControlPanelBrand:n,DBControlPanelNavigationItem:c,DBControlPanelNavigation:s},setup(){return{args:e}},template:`<div  :style="{
  width: '100%',
  display: 'block'
}"  ><DBControlPanelMobile v-bind="args"   >${e.default}</DBControlPanelMobile></div>`})},p=[`DefaultTop`,`Bottom`],d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    "position": "top",
...
}`,...f.parameters?.docs?.source}}}})))()}m();export{f as Bottom,d as DefaultTop,p as __namedExportsOrder,u as default};