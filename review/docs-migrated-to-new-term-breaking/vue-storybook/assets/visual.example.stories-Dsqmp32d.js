...
/></template>`},render:e=>({components:{DBNotification:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
}"  ><DBNotification v-bind="args"   >${e.default}</DBNotification></div>`})},s=[`DefaultIcon`,`Image`],a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...o.parameters?.docs?.source}}}})))()}c();export{a as DefaultIcon,o as Image,s as __namedExportsOrder,i as default};