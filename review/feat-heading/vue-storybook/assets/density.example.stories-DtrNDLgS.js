import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./brand-K8fc3XoS.js";import{n as r,t as i}from"./button-CLKgEBBM.js";import{n as a,t as o}from"./navigation-item-CZss0Nf3.js";import{n as s,t as c}from"./header-fHZM7wgy.js";import{n as l,t as u}from"./link-CLXxlN8K.js";import{n as d,t as f}from"./navigation-Bq_-UVGe.js";var p,m,h,g,_,v;function y(){return(y=e((()=>{t(),r(),u(),o(),f(),s(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/DBHeader/Density`,component:c,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},drawerOpen:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},h={args:{"data-density":`functional`,default:`<DBNavigation aria-label="Functional" v-bind="{}"
