import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./badge-j5NQGVEX.js";import{n as r,t as i}from"./button-CLKgEBBM.js";import{i as a,n as o,r as s,t as c}from"./drawer-header-Dw-ehrtP.js";import{n as l,t as u}from"./drawer-footer-oAfPGKw7.js";import{n as d,t as f}from"./link-CLXxlN8K.js";var p,m,h,g,_,v;function y(){return(y=e((()=>{t(),r(),l(),o(),f(),a(),{fn:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/DBDrawer/Example`,component:s,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:p()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},h={args:{variant:`modal`,open:!1,onClose:p(),default:`(Default) As modal<template v-slot:header
