import{n as e}from"./chunk-DnJy8xQt.js";import{g as t,p as n,t as r}from"./src-B5SWjDIc.js";var i,a,o,s,c,l,u,d,f,p,m;e((()=>{r(),{fn:i}=__STORYBOOK_MODULE_TEST__,a={title:`Components/DBNotification/Examples - Variant:Standalone`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:i()},argTypes:{headline:{control:`text`},showIcon:{control:`boolean`},variant:{control:`select`,options:[`docked`,`standalone`,`overlay`]},semantic:{control:`select`,options:[`adaptive`,`neutral`,`critical`,`informational`,`warning`,`successful`]},closeable:{control:`boolean`},linkVariant:{control:`select`,options:[`block`,`inline`]},showHeadline:{control:`boolean`},showTimestamp:{control:`boolean`},timestamp:{control:`text`},ariaLive:{control:`select`,options:[`assertive`,`polite`,`off`]},text:{control:`text`},role:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},o={args:{variant:`standalone`,default:`Text`},render:e=>({components:{DBNotification:n,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
