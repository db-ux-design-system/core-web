import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./badge-CESB7Uv9.js";import{n as r,t as i}from"./button-D2FL278l.js";import{i as a,n as o,r as s,t as c}from"./drawer-header-BmfXIbE_.js";import{n as l,t as u}from"./icon-Bvdhhqjv.js";var d,f,p,m,h,g;function _(){return(_=e((()=>{t(),r(),o(),l(),a(),{fn:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components/DBDrawer/Header`,component:s,parameters:{layout:`centered`},tags:[`autodocs`],args:{onClose:d()},argTypes:{open:{control:`boolean`},containerSize:{control:`select`,options:[`small`,`medium`,`large`,`full`]},rounded:{control:`boolean`},showSpacing:{control:`boolean`},backdrop:{control:`select`,options:[`none`,`strong`,`weak`,`invisible`]},direction:{control:`select`,options:[`to-left`,`to-right`,`up`,`down`]},variant:{control:`select`,options:[`modal`,`inside`]},position:{control:`select`,options:[`fixed`,`absolute`]},id:{control:`text`},autofocus:{control:`boolean`},onClose:{action:`onClose`}}},p={args:{open:!1,onClose:d(),default:`Content<template v-slot:header
  ><DBDrawerHeader
    text="With text prop"
