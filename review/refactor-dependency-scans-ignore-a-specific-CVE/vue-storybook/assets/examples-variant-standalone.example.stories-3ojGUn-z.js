import{_ as e}from"./notification-DSga0qL6.js";import{_ as t}from"./link-n3W5Rnq8.js";import"./iframe-X5rxoz3r.js";import"./preload-helper-DS_z_ILI.js";import"./constants-BMPlMwqI.js";import"./index-BYA9AoU-.js";import"./button-SlLiCZvv.js";const{fn:D}=__STORYBOOK_MODULE_TEST__,k={title:"Components/DBNotification/Examples - Variant:Standalone",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},i={args:{variant:"standalone",default:"Text"},render:n=>({components:{DBNotification:e,DBLink:t},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
