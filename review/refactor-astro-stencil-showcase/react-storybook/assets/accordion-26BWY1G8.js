import{j as o}from"./jsx-runtime-u17CrQMm.js";import{c as p,g as y,f as v}from"./index-20fQ7N7z.js";import{r as t}from"./iframe-D-PfmYcM.js";import{D as w}from"./accordion-item-wqzFETCC.js";function T(e,d){const f=t.useId(),a=d||t.useRef(d),[r,s]=t.useState(()=>""),[c,u]=t.useState(()=>!1),[l,m]=t.useState(()=>!1);function h(){try{return typeof e.items=="string"?JSON.parse(e.items):e.items}catch(n){console.error(n)}return[]}return t.useEffect(()=>{u(!0),m(!0)},[]),t.useEffect(()=>{c&&a.current&&(e.behavior==="single"?e.name?r!==e.name&&s(e.name):s(`accordion-${f}`):s(""))},[c,e.name,e.behavior]),t.useEffect(()=>{if(a.current){const n=a.current.getElementsByTagName("details");if(n)for(const i of Array.from(n))r===""?i.removeAttribute("name"):i.name=r??""}},[a.current,r]),t.useEffect(()=>{if(a.current&&l){if(e?.initOpenIndex&&e.initOpenIndex.length>0){const n=a.current.getElementsByTagName("details");if(n){const i=e.behavior==="single"&&e.initOpenIndex.length>1?[e.initOpenIndex[0]]:e.initOpenIndex;Array.from(n).forEach((g,b)=>{i?.includes(b)&&(g.open=!0)})}}m(!1)}},[a.current,l,e.initOpenIndex]),o.jsx("ul",{ref:a,...v(e,["data-icon-variant","data-icon-variant-before","data-icon-variant-after","data-icon-weight","data-icon-weight-before","data-icon-weight-after","data-interactive","data-force-mobile","data-color","data-container-color","data-bg-color","data-on-bg-color","data-color-scheme","data-font-size","data-headline-size","data-divider","data-focus","data-font","data-density"]),id:e.id,...y(e,["data-icon-variant","data-icon-variant-before","data-icon-variant-after","data-icon-weight","data-icon-weight-before","data-icon-weight-after","data-interactive","data-force-mobile","data-color","data-container-color","data-bg-color","data-on-bg-color","data-color-scheme","data-font-size","data-headline-size","data-divider","data-focus","data-font","data-density"]),className:p("db-accordion",e.className),"data-variant":e.variant,children:e.items?o.jsx(o.Fragment,{children:h()?.map((n,i)=>o.jsx(w,{headlinePlain:n.headlinePlain,disabled:n.disabled,text:n.text},`accordion-item-${i}`))}):o.jsx(o.Fragment,{children:e.children})})}const x=t.forwardRef(T);x.__docgenInfo={description:"",methods:[],displayName:"DBAccordion",props:{behavior:{required:!1,tsType:{name:"unknown[number]",raw:"(typeof AccordionBehaviorList)[number]"},description:"To allow multiple items open at the same time or only 1 item"},initOpenIndex:{required:!1,tsType:{name:"Array",elements:[{name:"number"}],raw:"number[]"},description:"The index of items which should be open when loading the accordion"},items:{required:!1,tsType:{name:"union",raw:"DBAccordionItemDefaultProps[] | string",elements:[{name:"Array",elements:[{name:"intersection",raw:`{
  /**
   ...
   */
  headlinePlain?: string;
}`,signature:{properties:[{key:"defaultOpen",value:{name:"boolean",required:!1},description:"Initial state for the accordion item"},{key:"open",value:{name:"boolean",required:!1},description:"State for the accordion item"},{key:"disabled",value:{name:"union",raw:"boolean | string",elements:[{name:"boolean"},{name:"string"}],required:!1},description:"The disabled attribute can be set to keep a user from clicking on the element."},{key:"headline",value:{name:"any",required:!1},description:"Title of the accordion-item as slot"},{key:"headlinePlain",value:{name:"string",required:!1},description:"Title of the accordion-item as plain text"}]}},{name:"signature",type:"object",raw:`{
  /**
