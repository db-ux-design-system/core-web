import{i as e}from"./preload-helper-CpdXSnB_.js";import{D as t,h as n,m as r,t as i}from"./src-DDJ4zMbe.js";var a,o,s,c,l,u;e((()=>{i(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/DBNavigation/Density`,component:n,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{id:{control:`text`},autofocus:{control:`boolean`}}},s={args:{"aria-labelledby":`functional`,default:`<DBNavigationItem>
  Navi-Item 1
