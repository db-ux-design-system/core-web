import{i as e}from"./preload-helper-CpdXSnB_.js";import{A as t,g as n,h as r,k as i,m as a,t as o,v as s}from"./src-DDJ4zMbe.js";var c,l,u,d,f,p;e((()=>{o(),{fn:c}=__STORYBOOK_MODULE_TEST__,l={title:`Components/DBHeader/Width`,component:s,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{width:{control:`select`,options:[`full`,`medium`,`large`,`small`]},forceMobile:{control:`boolean`},drawerOpen:{control:`boolean`},burgerMenuLabel:{control:`text`},closeButtonId:{control:`text`},closeButtonText:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},u={args:{default:`<DBNavigation aria-label="Full" v-bind="{}"
