import{_ as a}from"./notification-CVW3NWYf.js";import"./iframe-DVvurW3a.js";import"./preload-helper-CGi0K3Zh.js";import"./constants-y2N5m1XS.js";import"./index-Bpz0UvTb.js";import"./button-Dcw_BP9i.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,f={title:"Components/DBNotification/Variant",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},t={args:{variant:"docked",headline:"Headline",icon:"information_circle",default:"(Default) Docked"},render:n=>({components:{DBNotification:a},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
