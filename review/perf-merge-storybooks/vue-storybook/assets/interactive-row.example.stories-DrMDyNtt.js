...
>`},render:e=>({components:{DBTable:p,DBButton:n,DBInfotext:i,DBTableBody:s,DBTableDataCell:f,DBTableHead:u,DBTableHeaderCell:l,DBTableRow:v,DBTooltip:a},setup(){return{args:e}},template:`<div  :style="{
  ...
  padding: 'var(--db-spacing-fixed-md)'
                    ...
                    Spaced
                </DBInfotext><DBTable v-bind="args"   >${e.default}</DBTable></div>`})},C=[`Flat`,`Spaced`],x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    "captionPlain": "Flat",
    "default": \`<DBTableHead
  ><DBTableRow
...
}`,...S.parameters?.docs?.source}}}})))()}w();export{x as Flat,S as Spaced,C as __namedExportsOrder,b as default};