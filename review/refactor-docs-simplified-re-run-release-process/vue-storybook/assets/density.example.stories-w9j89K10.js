import{_ as i}from"./notification-BPIJEE3B.js";import"./iframe-CcI2n9bD.js";import"./preload-helper-CW5SJR8L.js";import"./constants-y2N5m1XS.js";import"./index-BSAZCWsy.js";import"./button-DMF7G5k1.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,u={title:"Components/DBNotification/Density",component:i,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},e={args:{"data-density":"functional",headline:"Headline",icon:"information_circle",default:"functional"},render:n=>({components:{DBNotification:i},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
