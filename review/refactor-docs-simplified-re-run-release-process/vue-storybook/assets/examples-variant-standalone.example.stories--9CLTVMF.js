import{_ as t}from"./link--QY9S_Tm.js";import{_ as e}from"./notification-CDQ66jc0.js";import"./iframe-CLK2hyyp.js";import"./preload-helper-CW5SJR8L.js";import"./index-BSAZCWsy.js";import"./constants-y2N5m1XS.js";import"./button-th3CS6ih.js";const{fn:D}=__STORYBOOK_MODULE_TEST__,k={title:"Components/DBNotification/Examples - Variant:Standalone",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},i={args:{variant:"standalone",default:"Text"},render:n=>({components:{DBNotification:e,DBLink:t},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
