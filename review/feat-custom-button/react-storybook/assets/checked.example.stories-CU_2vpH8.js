import{j as a}from"./jsx-runtime-u17CrQMm.js";import{D as t}from"./radio-HNPVT7r0.js";import"./index-C0vvPcr0.js";import"./iframe-BAon8gc_.js";import"./preload-helper-COTrxSA1.js";import"./form-components-DI5fDEQF.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,p={title:"Components/DBRadio/Checked",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{name:{control:"text"},value:{control:"text"},disabled:{control:"boolean"},checked:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},size:{control:"select",options:["small","medium"]},required:{control:"boolean"},showLabel:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},label:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{name:"Checked",children:"(Default) False"},render:r=>a.jsx(t,{...r})},o={args:{name:"Checked",checked:!0,children:"True"},render:r=>a.jsx(t,{...r})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    "name": "Checked",
