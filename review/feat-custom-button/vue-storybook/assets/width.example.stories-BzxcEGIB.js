import{_ as n}from"./custom-button-D4NSOhdU.js";import{_ as o}from"./infotext-DRMwgSt_.js";import"./iframe-Bo8iO6Ti.js";import"./preload-helper-BVUwd7FV.js";import"./index-ahyD-phA.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,f={title:"Components/DBCustomButton/Width",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{variant:{control:"select",options:["outlined","brand","ghost","filled"]},disabled:{control:"boolean"},noText:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},width:{control:"select",options:["full","auto"]},size:{control:"select",options:["small","medium"]},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{width:"auto",default:"<button>Button</button>"},render:t=>({components:{DBCustomButton:n,DBInfotext:o},setup(){return{args:t}},template:`<DBCustomButton v-bind="args"   >${t.default}</DBCustomButton>`})},u={args:{width:"auto",default:`<label
  ><input type="checkbox" />
  Checkbox
</label>`},render:t=>({components:{DBCustomButton:n,DBInfotext:o},setup(){return{args:t}},template:`<DBCustomButton v-bind="args"   >${t.default}</DBCustomButton>`})},s={args:{width:"auto",default:'<a href="#">Link</a>'},render:t=>({components:{DBCustomButton:n,DBInfotext:o},setup(){return{args:t}},template:`<DBCustomButton v-bind="args"   >${t.default}</DBCustomButton>`})},a={args:{width:"full",default:"<button>Button</button>"},render:t=>({components:{DBCustomButton:n,DBInfotext:o},setup(){return{args:t}},template:`<div  :style="{
  width: '500px'
