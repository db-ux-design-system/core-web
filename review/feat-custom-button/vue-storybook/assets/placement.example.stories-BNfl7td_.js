import{_ as o}from"./tooltip-C8Lrd1X-.js";import{_ as n}from"./button-BMLVNzHn.js";import"./iframe-BP23YJLJ.js";import"./preload-helper-BVUwd7FV.js";import"./constants-CvUrIGJS.js";import"./index-D_V5zbEX.js";import"./document-scroll-listener-DAKXbHx-.js";import"./floating-components-jmncKSnU.js";const{fn:y}=__STORYBOOK_MODULE_TEST__,S={title:"Components/DBTooltip/Placement",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{id:{control:"text"},showArrow:{control:"boolean"},emphasis:{control:"select",options:["weak","strong"]},placement:{control:"select",options:["top","bottom","top-start","top-end","bottom-start","bottom-end","left","right","left-start","left-end","right-start","right-end"]},width:{control:"select",options:["auto","fixed"]},animation:{control:"boolean"},delay:{control:"select",options:["none","slow","fast"]},variant:{control:"select",options:["description","label"]},autofocus:{control:"boolean"}}},e={args:{placement:"bottom-start",id:"tooltip-08-start",default:"Tooltip"},render:t=>({components:{DBTooltip:o,DBButton:n},setup(){return{args:t}},template:`<DBButton    >
                bottom-start
