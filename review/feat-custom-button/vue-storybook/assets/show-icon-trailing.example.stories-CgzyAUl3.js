import{_ as t}from"./custom-button-D4NSOhdU.js";import{_ as o}from"./infotext-DRMwgSt_.js";import"./iframe-Bo8iO6Ti.js";import"./preload-helper-BVUwd7FV.js";import"./index-ahyD-phA.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,g={title:"Components/DBCustomButton/Show Icon Trailing",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{variant:{control:"select",options:["outlined","brand","ghost","filled"]},disabled:{control:"boolean"},noText:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},width:{control:"select",options:["full","auto"]},size:{control:"select",options:["small","medium"]},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{iconTrailing:"x_placeholder",showIconTrailing:!1,default:"<button>Button</button>"},render:n=>({components:{DBCustomButton:t,DBInfotext:o},setup(){return{args:n}},template:`<DBCustomButton v-bind="args"   >${n.default}</DBCustomButton>`})},r={args:{iconTrailing:"x_placeholder",showIconTrailing:!1,default:`<label
  ><input type="checkbox" />
  Checkbox
</label>`},render:n=>({components:{DBCustomButton:t,DBInfotext:o},setup(){return{args:n}},template:`<DBCustomButton v-bind="args"   >${n.default}</DBCustomButton>`})},a={args:{iconTrailing:"x_placeholder",showIconTrailing:!1,default:'<a href="#">Link</a>'},render:n=>({components:{DBCustomButton:t,DBInfotext:o},setup(){return{args:n}},template:`<DBCustomButton v-bind="args"   >${n.default}</DBCustomButton>`})},s={args:{iconTrailing:"x_placeholder",showIconTrailing:!0,default:"<button>Button</button>"},render:n=>({components:{DBCustomButton:t,DBInfotext:o},setup(){return{args:n}},template:`<DBCustomButton v-bind="args"   >${n.default}</DBCustomButton>`})},u={args:{iconTrailing:"x_placeholder",showIconTrailing:!0,default:`<label
  ><input type="checkbox" />
  Checkbox
