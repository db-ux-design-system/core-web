import{_ as t}from"./link-BD9SQzsf.js";import{_ as n}from"./notification-q7uu72E6.js";import"./iframe-q-AYLWxZ.js";import"./preload-helper-CDE7oBwp.js";import"./index-C-vJ4oTM.js";import"./constants-CRDP6LoT.js";import"./button-CkPmRBAb.js";const{fn:B}=__STORYBOOK_MODULE_TEST__,b={title:"Components/DBNotification/Examples - Variant:Overlay",component:n,parameters:{layout:"centered"},tags:["autodocs"],args:{onClose:B()},argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},i={args:{variant:"overlay",default:"Text"},render:e=>({components:{DBNotification:n,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
...
>`},render:e=>({components:{DBNotification:n,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
}"  ><DBNotification v-bind="args"   >${e.default}</DBNotification></div>`})},d={args:{variant:"overlay",linkVariant:"block",timestamp:"10 min ago",showTimestamp:!0,default:`Text & Textlink Block & Timed<template v-slot:link
  ><DBLink href="#">Textlink</DBLink></template
>`},render:e=>({components:{DBNotification:n,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
}"  ><DBNotification v-bind="args"   >${e.default}</DBNotification></div>`})},c={args:{headline:"Headline",variant:"overlay",linkVariant:"inline",closeable:!0,default:`Text & Headline & Textlink Inline & Closeable<template v-slot:link
  ><DBLink href="#">Textlink</DBLink></template
>`},render:e=>({components:{DBNotification:n,DBLink:t},setup(){return{args:e}},template:`<div  :style="{
  width: '300px'
...
}`,...v.parameters?.docs?.source}}};const h=["Text","TextIcon","TextPreviewImage","TextHeadline","TextTextlinkInline","TextTextlinkBlock","TextTextlinkBlockTimed","TextHeadlineTextlinkInlineCloseable","TextIconHeadlineTextlinkInlineCloseable","TextTimed","TextTimedCloseable","TextHeadlineTimedCloseable","TextIconHeadlineTimedCloseable"];export{i as Text,r as TextHeadline,c as TextHeadlineTextlinkInlineCloseable,f as TextHeadlineTimedCloseable,a as TextIcon,m as TextIconHeadlineTextlinkInlineCloseable,v as TextIconHeadlineTimedCloseable,o as TextPreviewImage,s as TextTextlinkBlock,d as TextTextlinkBlockTimed,l as TextTextlinkInline,p as TextTimed,u as TextTimedCloseable,h as __namedExportsOrder,b as default};
