import{_ as o,a as s}from"./tab-list-9KFON3-2.js";import{_ as n}from"./badge-B-swl-Lq.js";import"./iframe-BBTet04s.js";import"./preload-helper-CDE7oBwp.js";import"./index-CrC2-ZEz.js";import"./tooltip-CxS7gocS.js";import"./document-scroll-listener-BflQilF1.js";import"./floating-components-CKmcRn_b.js";import"./constants-CRDP6LoT.js";const{fn:b}=__STORYBOOK_MODULE_TEST__,D={title:"Components/DBTabItem/Slot with Badge",component:s,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},noText:{control:"boolean"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{default:`<span
  :style="{
  display: 'flex',
  alignItems: 'center',
  gap: '8px'
