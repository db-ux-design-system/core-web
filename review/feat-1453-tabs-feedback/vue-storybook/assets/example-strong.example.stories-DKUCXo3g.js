import{_ as e}from"./tag-BeLQawv7.js";import"./iframe-DqItoT3r.js";import"./preload-helper-CDE7oBwp.js";import"./constants-CRDP6LoT.js";import"./index-v_uYr-ku.js";import"./tooltip-DIhGhH0W.js";import"./document-scroll-listener-d8pwIYFb.js";import"./floating-components-CKmcRn_b.js";const{fn:h}=__STORYBOOK_MODULE_TEST__,b={title:"Components/DBTag/Example Strong",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{emphasis:{control:"select",options:["weak","strong"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},behavior:{control:"select",options:["static","removable"]},showIcon:{control:"boolean"},noText:{control:"boolean"},content:{control:"text"},showCheckState:{control:"boolean"},overflow:{control:"boolean"},removeButton:{control:"text"},text:{control:"text"},value:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onRemove:{action:"onRemove"}}},t={args:{emphasis:"strong",icon:"x_placeholder",behavior:"removable",default:"<button>Interactive Strong Button with Icon</button>"},render:n=>({components:{DBTag:e},setup(){return{args:n}},template:`<DBTag v-bind="args"   >${n.default}</DBTag>`})},a={args:{emphasis:"strong",icon:"x_placeholder",default:'<a href="#">Interactive Strong Link with Icon</a>'},render:n=>({components:{DBTag:e},setup(){return{args:n}},template:`<DBTag v-bind="args"   >${n.default}</DBTag>`})},o={args:{emphasis:"strong",icon:"x_placeholder",default:`<label
  ><input type="checkbox" />
