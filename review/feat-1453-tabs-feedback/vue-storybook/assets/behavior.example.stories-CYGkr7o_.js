import{_ as n,a as o}from"./tab-list-DYxMPwoG.js";import"./iframe-Br7nUqWT.js";import"./preload-helper-CDE7oBwp.js";import"./index-CAc947dM.js";import"./tooltip-CNbO9lhP.js";import"./constants-CvUrIGJS.js";import"./document-scroll-listener-C99HqdfC.js";import"./floating-components-jmncKSnU.js";const{fn:u}=__STORYBOOK_MODULE_TEST__,p={title:"Components/DBTabItem/Behavior",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},noText:{control:"boolean"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{label:"(Default) Auto Width",default:""},render:t=>({components:{DBTabItem:n,DBTabList:o},setup(){return{args:t}},template:`<DBTabList    ><DBTabItem v-bind="args"   >${t.default}</DBTabItem></DBTabList>`})},a={args:{label:"Width full",default:""},render:t=>({components:{DBTabItem:n,DBTabList:o},setup(){return{args:t}},template:`<DBTabList  :style="{
  blockSize: '100%'
