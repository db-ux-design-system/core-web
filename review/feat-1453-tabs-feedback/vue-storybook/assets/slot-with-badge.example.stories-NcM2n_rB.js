import{_ as o,a as s}from"./tab-list-CBwb4hYp.js";import{_ as n}from"./badge-D-LnVpwd.js";import"./iframe-DqItoT3r.js";import"./preload-helper-CDE7oBwp.js";import"./index-v_uYr-ku.js";import"./tooltip-DIhGhH0W.js";import"./document-scroll-listener-d8pwIYFb.js";import"./floating-components-CKmcRn_b.js";import"./constants-CRDP6LoT.js";const{fn:b}=__STORYBOOK_MODULE_TEST__,D={title:"Components/DBTabItem/Slot with Badge",component:s,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},showIcon:{control:"boolean"},showIconLeading:{control:"boolean"},showIconTrailing:{control:"boolean"},noText:{control:"boolean"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{default:`<span
  :style="{
  display: 'flex',
  alignItems: 'center',
  gap: '8px'
