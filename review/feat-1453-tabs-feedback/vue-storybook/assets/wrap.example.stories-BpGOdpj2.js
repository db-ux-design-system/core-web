import{_ as n}from"./navigation-item-BG_iEoQq.js";import"./iframe-C39u1JGI.js";import"./preload-helper-CDE7oBwp.js";import"./constants-CvUrIGJS.js";import"./index-CxtH_N9b.js";import"./floating-components-CKmcRn_b.js";import"./button-CIkRIuCd.js";const{fn:p}=__STORYBOOK_MODULE_TEST__,v={title:"Components/DBNavigationItem/Wrap",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{disabled:{control:"boolean"},active:{control:"boolean"},showIcon:{control:"boolean"},width:{control:"select",options:["full","auto"]},wrap:{control:"boolean"},text:{control:"text"},subNavigationExpanded:{control:"boolean"},backButtonId:{control:"text"},backButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},a={args:{default:'<a href="#">No Wrap (Default)</a>'},render:t=>({components:{DBNavigationItem:n},setup(){return{args:t}},template:`<ul    ><DBNavigationItem v-bind="args"   >${t.default}</DBNavigationItem></ul>`})},e={args:{icon:"x_placeholder",showIcon:!0,wrap:!0,default:`This is a very long text that is broken into multiple lines.<template
