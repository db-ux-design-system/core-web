import{_ as e}from"./notification-IdMO6HMi.js";import{_ as t}from"./link-BREEqgSi.js";import"./iframe-Cke17Jem.js";import"./preload-helper-CDE7oBwp.js";import"./constants-CvUrIGJS.js";import"./index-CxtH_N9b.js";import"./button-h5LZvjtZ.js";const{fn:D}=__STORYBOOK_MODULE_TEST__,k={title:"Components/DBNotification/Examples - Variant:Standalone",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{headline:{control:"text"},showIcon:{control:"boolean"},variant:{control:"select",options:["docked","standalone","overlay"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},closeable:{control:"boolean"},linkVariant:{control:"select",options:["block","inline"]},showHeadline:{control:"boolean"},showTimestamp:{control:"boolean"},timestamp:{control:"text"},ariaLive:{control:"select",options:["assertive","polite","off"]},text:{control:"text"},role:{control:"text"},closeButtonId:{control:"text"},closeButtonText:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onClose:{action:"onClose"}}},i={args:{variant:"standalone",default:"Text"},render:n=>({components:{DBNotification:e,DBLink:t},setup(){return{args:n}},template:`<div  :style="{
  width: '300px'
