import{i as e}from"./preload-helper-BvLp0nkB.js";import{Q as t,t as n,x as r}from"./src-CzUILOCC.js";var i,a,o,s,c;e((()=>{n(),{fn:i}=__STORYBOOK_MODULE_TEST__,a={title:`Components/DBRadio/Show Label`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{name:{control:`text`},value:{control:`text`},disabled:{control:`boolean`},checked:{control:`boolean`},validation:{control:`select`,options:[`invalid`,`valid`,`no-validation`]},size:{control:`select`,options:[`small`,`medium`]},required:{control:`boolean`},showLabel:{control:`boolean`},showRequiredAsterisk:{control:`boolean`},label:{control:`text`},form:{control:`text`},ariaDescribedBy:{control:`text`},id:{control:`text`},autofocus:{control:`boolean`}}},o={args:{name:`Content`,showLabel:!0,default:`(Default) True`},render:e=>({components:{DBRadio:r,DBInfotext:t},setup(){return{args:e}},template:`<DBRadio v-bind="args"   >${e.default}</DBRadio>`})},s={args:{name:`Content`,showLabel:!1,default:`False`},render:e=>({components:{DBRadio:r,DBInfotext:t},setup(){return{args:e}},template:`<div    ><DBRadio v-bind="args"   >${e.default}</DBRadio><DBInfotext semantic="informational" size="small" icon="none"   >
                    False
