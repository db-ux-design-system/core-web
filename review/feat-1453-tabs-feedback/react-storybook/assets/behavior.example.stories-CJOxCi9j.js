import{j as t}from"./jsx-runtime-u17CrQMm.js";import{D as n}from"./card-DGFMKAmy.js";import"./index-D2E5Z_bU.js";import"./iframe-BdxTISEc.js";import"./preload-helper--tLyh50B.js";const{fn:a}=__STORYBOOK_MODULE_TEST__,d={title:"Components/DBCard/Behavior",component:n,parameters:{layout:"centered"},tags:["autodocs"],args:{onClick:a()},argTypes:{behavior:{control:"select",options:["static","interactive"]},elevationLevel:{control:"select",options:["1","2","3"]},spacing:{control:"select",options:["medium","small","large","none"]},id:{control:"text"},autofocus:{control:"boolean"},onClick:{action:"onClick"}}},e={args:{behavior:"static",children:t.jsx("strong",{children:"(Default) Static"})},render:o=>t.jsx(n,{...o})},r={args:{behavior:"interactive",children:t.jsx("strong",{children:"Interactive"})},render:o=>t.jsx("button",{type:"button",children:t.jsx(n,{...o})})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    "behavior": "static",
