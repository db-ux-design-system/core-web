import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as a}from"./tag-CuSSLd8v.js";import"./index-C0vvPcr0.js";import"./iframe-CI0L_yqq.js";import"./preload-helper--tLyh50B.js";import"./constants-C-ysBZRi.js";import"./tooltip-CLewwZAd.js";import"./document-scroll-listener-C19Ex2M_.js";import"./floating-components-DAXMbqch.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,x={title:"Components/DBTag/Show Check State",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{emphasis:{control:"select",options:["weak","strong"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},behavior:{control:"select",options:["static","removable"]},showIcon:{control:"boolean"},noText:{control:"boolean"},content:{control:"text"},showCheckState:{control:"boolean"},overflow:{control:"boolean"},removeButton:{control:"text"},text:{control:"text"},value:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"},onRemove:{action:"onRemove"}}},o={args:{showCheckState:!0,children:e.jsxs("label",{children:[e.jsx("input",{type:"checkbox"}),"(Default) True"]})},render:r=>e.jsx(a,{...r})},t={args:{showCheckState:!1,children:e.jsxs("label",{children:[e.jsx("input",{type:"checkbox"}),"False"]})},render:r=>e.jsx(a,{...r})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    "showCheckState": true,
