...
><DBTableBody
  ><DBTableRow
    ...
    ></DBTableRow
  ></DBTableBody
>`},render:e=>({components:{DBTable:s,DBButton:n,DBInfotext:r,DBTableBody:o,DBTableDataCell:l,DBTableHead:a,DBTableHeaderCell:t,DBTableRow:i},setup(){return{args:e}},template:`<div  :style="{
  minInlineSize: '300px',
  display: 'flex',
