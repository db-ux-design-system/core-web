...
><span class="dummy-component">Content 3</span>`},render:e=>({components:{DBStack:r,DBInfotext:n},setup(){return{args:e}},template:`<div  :style="{
  ...
  height: '100px'
                    ...
                    Wrap: Row
                </DBInfotext><DBStack v-bind="args"   >${e.default}</DBStack></div>`})},d=[`DefaultNoWrapColumn`,`NoWrapRow`,`WrapColumn`,`WrapRow`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    "style": {
...
}`,...u.parameters?.docs?.source}}}})))()}f();export{s as DefaultNoWrapColumn,c as NoWrapRow,l as WrapColumn,u as WrapRow,d as __namedExportsOrder,o as default};