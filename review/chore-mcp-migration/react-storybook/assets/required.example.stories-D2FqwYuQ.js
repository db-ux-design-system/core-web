import{j as a}from"./jsx-runtime-u17CrQMm.js";import{D as t}from"./radio-CgfvSC9Z.js";import"./index-D2E5Z_bU.js";import"./iframe-XIL_u0US.js";import"./preload-helper-C6vsLNg4.js";import"./form-components-OaQ73I72.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,u={title:"Components/DBRadio/Required",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{name:{control:"text"},value:{control:"text"},disabled:{control:"boolean"},checked:{control:"boolean"},validation:{control:"select",options:["invalid","valid","no-validation"]},size:{control:"select",options:["small","medium"]},required:{control:"boolean"},showLabel:{control:"boolean"},showRequiredAsterisk:{control:"boolean"},label:{control:"text"},form:{control:"text"},ariaDescribedBy:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},e={args:{name:"Requirement",required:!1,children:"(Default) False"},render:o=>a.jsx(t,{...o})},r={args:{name:"Requirement",required:!0,children:"True"},render:o=>a.jsx(t,{...o})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    "name": "Requirement",
    "required": false,
