...
><template v-slot:meta
  ><nav aria-label="Show meta enabled legal navigation"
    ...
    ></nav
  ></template
>`},render:e=>({components:{DBFooter:n},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},o={args:{showMeta:!1,default:`<nav aria-label="Show meta disabled footer navigation"
  ><ul
...
>`},render:e=>({components:{DBFooter:n},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    "showMeta": true,
    "default": \`<nav aria-label="Show meta enabled footer navigation"
  ><ul
    ><li><a href="#services" class="db-link"> Services </a></li></ul
  ></nav
><template v-slot:meta
...
>\`
  ...
  args: {
    "showMeta": false,
    "default": \`<nav aria-label="Show meta disabled footer navigation"
  ><ul
    ><li><a href="#contact" class="db-link"> Contact </a></li></ul
  ></nav
>\`
