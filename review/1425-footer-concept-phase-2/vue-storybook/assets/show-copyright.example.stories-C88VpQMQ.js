...
><template v-slot:meta
  ><nav aria-label="Legal navigation"
    ...
    ></nav
  ></template
>`},render:e=>({components:{DBFooter:n},setup(){return{args:e}},template:`<DBFooter v-bind="args"   >${e.default}</DBFooter>`})},o={args:{showCopyright:!1,default:`<nav aria-label="Footer navigation"
  ><ul
