import{_ as o}from"./infotext-DxjfRvK2.js";import"./iframe-BQAbYFr7.js";import"./preload-helper-CwrvtnRA.js";import"./index-BSAZCWsy.js";const{fn:m}=__STORYBOOK_MODULE_TEST__,c={title:"Components/DBInfotext/Size",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},size:{control:"select",options:["small","medium"]},showIcon:{control:"boolean"},text:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},t={args:{default:"(Default) Medium"},render:e=>({components:{DBInfotext:o},setup(){return{args:e}},template:`<DBInfotext v-bind="args"   >${e.default}</DBInfotext>`})},n={args:{size:"small",default:"Small"},render:e=>({components:{DBInfotext:o},setup(){return{args:e}},template:`<DBInfotext v-bind="args"   >${e.default}</DBInfotext>`})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
