import{_ as e}from"./badge-BxtkCZNd.js";import{_ as t}from"./infotext-CEHQ5DTk.js";import{_ as o}from"./icon-Bzhn8QJx.js";import{_ as r}from"./button-C47gFWkX.js";import"./iframe-Bmf1EjZo.js";import"./preload-helper-_n2GBM2K.js";import"./constants-BMPlMwqI.js";import"./index-nMDAkmV1.js";const{fn:v}=__STORYBOOK_MODULE_TEST__,h={title:"Components/DBBadge/Placement",component:e,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{emphasis:{control:"select",options:["weak","strong"]},semantic:{control:"select",options:["adaptive","neutral","critical","informational","warning","successful"]},size:{control:"select",options:["small","medium"]},placement:{control:"select",options:["inline","corner-top-left","corner-top-right","corner-center-left","corner-center-right","corner-bottom-left","corner-bottom-right"]},label:{control:"text"},text:{control:"text"},id:{control:"text"},autofocus:{control:"boolean"}}},a={args:{size:"small",emphasis:"strong",semantic:"critical",default:"Label"},render:n=>({components:{DBBadge:e,DBButton:r,DBIcon:o,DBInfotext:t},setup(){return{args:n}},template:`<div class="badge-inline-container"   ><span data-icon="x_placeholder"   >(Default) Inline</span><DBBadge v-bind="args"   >${n.default}</DBBadge><DBIcon icon="error"   ></DBIcon></div>`})},s={args:{size:"small",emphasis:"strong",semantic:"critical",placement:"corner-top-left",default:""},render:n=>({components:{DBBadge:e,DBButton:r,DBIcon:o,DBInfotext:t},setup(){return{args:n}},template:`<div    ><DBButton data-sb-decorator="true" icon="x_placeholder" variant="outlined" :noText="true"  ><DBBadge v-bind="args"   >${n.default}</DBBadge></DBButton><DBInfotext size="small" semantic="informational" icon="none"   >
                    ...
                    Corner - Bottom- Left
                </DBInfotext></div>`})},l={args:{size:"small",emphasis:"strong",semantic:"critical",placement:"corner-top-right",default:""},render:n=>({components:{DBBadge:e,DBButton:r,DBIcon:o,DBInfotext:t},setup(){return{args:n}},template:`<div    ><DBButton data-sb-decorator="true" icon="x_placeholder" variant="outlined" :noText="true"  ><DBBadge v-bind="args"   >${n.default}</DBBadge></DBButton><DBInfotext size="small" semantic="informational" icon="none"   >
                    Corner - Top - Right
                </DBInfotext></div>`})},B={args:{size:"small",emphasis:"strong",semantic:"critical",placement:"corner-center-right",default:""},render:n=>({components:{DBBadge:e,DBButton:r,DBIcon:o,DBInfotext:t},setup(){return{args:n}},template:`<div    ><DBButton data-sb-decorator="true" icon="x_placeholder" variant="outlined" :noText="true"  ><DBBadge v-bind="args"   >${n.default}</DBBadge></DBButton><DBInfotext size="small" semantic="informational" icon="none"   >
                    Corner - Center - Right
  ...
  render: (args: any) => ({
    ...
    template: \`<div    ><DBButton data-sb-decorator="true" icon="x_placeholder" variant="outlined" :noText="true"  ><DBBadge v-bind="args"   >\${args.default}</DBBadge></DBButton><DBInfotext size="small" semantic="informational" icon="none"   >
                    Corner - Top - Left
                </DBInfotext></div>\`
  })
...
}`,...d.parameters?.docs?.source}}};const b=["DefaultInline","CornerTopLeft","CornerCenterLeft","CornerBottomLeft","CornerTopRight","CornerCenterRight","CornerBottomRight"];export{c as CornerBottomLeft,d as CornerBottomRight,i as CornerCenterLeft,B as CornerCenterRight,s as CornerTopLeft,l as CornerTopRight,a as DefaultInline,b as __namedExportsOrder,h as default};
