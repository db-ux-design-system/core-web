...
Adding the component name (or an alternative phrase in the case of a differently scoped PR) as context in brackets after the prefix helps users to quickly skim through our information and its clusters.
